...
//
//-----------------------------------------------------------
class BastionShieldCannonProjectile extends ShockProjectile;
...
{
    if (Owner != None && BastionShieldCannon(Owner) != None && Other == BastionShieldCannon(Owner).ShockShield)
        ProximityExplode();
    else
...
simulated singular function HitWall(vector HitNormal, actor Wall)
{
    ...
    if (Owner != None && BastionShieldCannon(Owner) != None && Wall == BastionShieldCannon(Owner).ShockShield)
        ProximityExplode();
    else
    {
...
function ProximityExplode()
{
    ...
    BastionShieldCannon(Owner).ProximityExplosion();
    Destroy();
}
...
function SuperExplosion()
{
	...
	Spawn(class'BastionShockExplosion');
