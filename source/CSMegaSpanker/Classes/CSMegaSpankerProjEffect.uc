...
//
//-----------------------------------------------------------
class CSMegaSpankerProjEffect extends CSSpankBadgerProjectileEffect;

#exec OBJ LOAD FILE="..\Textures\AW-2k4XP.utx"
//#exec TEXTURE IMPORT FORMAT=DXT5 FILE=Textures\SpankerEffectCore.dds
...
DefaultProperties
{
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter11
        ...
        StartSizeRange=(X=(Min=180.000000,Max=180.000000))
        InitialParticlesPerSecond=6.000000
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter12
        ...
        UseRegularSizeScale=False
        UniformSize=True
        ColorScale(1)=(RelativeTime=0.200000,Color=(B=163,G=200,R=213))
        ColorScale(2)=(RelativeTime=0.800000,Color=(B=155,G=209,R=163))
        ColorScale(3)=(RelativeTime=1.000000)
        CoordinateSystem=PTCS_Relative
        MaxParticles=3
    ...
    Begin Object Class=MeshEmitter Name=MeshEmitter7
        ...
        StartSizeRange=(X=(Min=1.50000,Max=1.50000))
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter14
        ...
        ColorScale(1)=(RelativeTime=0.200000,Color=(B=0,G=0,R=255))
        ColorScale(2)=(RelativeTime=0.500000,Color=(B=0,G=240,R=240))
    ...
    Begin Object Class=TrailEmitter Name=TrailEmitter0
        ...
        ColorScale(0)=(Color=(B=10,G=120,R=255))
