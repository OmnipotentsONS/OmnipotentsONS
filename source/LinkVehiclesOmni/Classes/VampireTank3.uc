//  Vampire Tank 3.0 updated by pOOty
// ============================================================================
// Link Tank 2.0
...
class VampireTank3 extends ONSHoverTank;
...
// ============================================================================
// C/P'd Ion Tank stuff, this prevents Zoom on AltFire.
// ============================================================================
function AltFire(optional float F)
{
	//log(self@"AltFire Called...");
...
static function StaticPrecache(LevelInfo L)
{
	...
	L.AddPrecacheMaterial(Material'LinkTank3Tex.VampireTank.VampireTankBodyBlue');
	L.AddPrecacheMaterial(Material'LinkTank3Tex.VampireTank.VampireTankBodyRed');
	...
	L.AddPrecacheMaterial(Material'LinkTank3Tex.VampireTank.LinkTurretBlack1');
	L.AddPrecacheMaterial(Material'LinkTank3Tex.VampireTank.LinkTurretBlack2');
...
{
	Level.AddPrecacheMaterial(Material'LinkTank3Tex.VampireTank.VampireTankBodyBlue');
	Level.AddPrecacheMaterial(Material'LinkTank3Tex.VampireTank.VampireTankBodyRed');
  ...
  Level.AddPrecacheMaterial(Material'LinkTank3Tex.VampireTank.LinkTurretBlack1');
	Level.AddPrecacheMaterial(Material'LinkTank3Tex.VampireTank.LinkTurretBlack2');
...
defaultproperties
{
     ...
     LinkSkin_Gold(0)=Combiner'LinkTank3Tex.VampireTank.VampireTankBodyRed-Linking'
     LinkSkin_Gold(1)=Combiner'LinkTank3Tex.VampireTank.VampireTankBodyBlue-Linking'
     LinkSkin_Green(0)=Combiner'LinkTank3Tex.VampireTank.VampireTankBodyRed-Idle'
     LinkSkin_Green(1)=Combiner'LinkTank3Tex.VampireTank.VampireTankBodyBlue-Idle'
     LinkSkin_Red(0)=Combiner'LinkTank3Tex.VampireTank.VampireTankBodyRed-Linking'
     LinkSkin_Blue(1)=Combiner'LinkTank3Tex.VampireTank.VampireTankBodyBlue-Linking'
     MaxSteerTorque=160.000000
     DriverWeapons(0)=(WeaponClass=Class'LinkVehiclesOmni.VampireTank3Gun')
     PassengerWeapons(0)=(WeaponPawnClass=Class'LinkVehiclesOmni.VampireTank3SecondaryTurretPawn',WeaponBone="SecondaryTurretAttach")
     
    // PassengerWeapons(1)=(WeaponPawnClass=Class'LinkVehiclesOmni.VampireTank3TertiaryTurretPawn',WeaponBone="TertiaryTurretAttach")
     bHasAltFire=True
     RedSkin=Combiner'LinkTank3Tex.VampireTank.VampireTankBodyRed-Idle'
     BlueSkin=Combiner'LinkTank3Tex.VampireTank.VampireTankBodyBlue-Idle'
     ...
     VehicleNameString="Vampire Tank 3.12"
