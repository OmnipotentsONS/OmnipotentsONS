...
class TickScorpion3BeamEffect extends LinkBeamEffect;

var TickScorpion3Gun TickScorp3Gun;
...
simulated function SetBeamLocation()
{
    ...
    {
		TickScorp3Gun.CalcWeaponFire();
        StartEffect = TickScorp3Gun.WeaponFireLocation;
...
simulated function Vector SetBeamRotation()
{
    if ( (Instigator != None) && PlayerController(Instigator.Controller) != None )
        SetRotation( TickScorp3Gun.WeaponFireRotation);
    else
        SetRotation( TickScorp3Gun.WeaponFireRotation );
