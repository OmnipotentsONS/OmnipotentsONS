...
// ============================================================================
class LinkTank3SecondaryTurretPawn extends ONSWeaponPawn;
...
simulated event Tick(float DT)
{
	Super.Tick( DT );
 	...
 	if (Role == ROLE_Authority && VehicleBase != None && VehicleBase.Owner == None)  LinkTank3(VehicleBase).ResetLinks();
}

defaultproperties
{
     GunClass=Class'LinkVehiclesOmni.LinkTank3SecondaryTurret'
     bHasAltFire=False
