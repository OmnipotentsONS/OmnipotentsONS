...
class LinkTank3Mini extends ONSHoverTank;
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'LinkVehiclesOmni.LinkTank3MiniGun')
     PassengerWeapons(0)=(WeaponPawnClass=Class'LinkVehiclesOmni.LinkTank3MiniSecondaryTurretPawn',WeaponBone="SecondaryTurretAttach")
     ...
     VehicleNameString="Mini Link Tank 3.41"
