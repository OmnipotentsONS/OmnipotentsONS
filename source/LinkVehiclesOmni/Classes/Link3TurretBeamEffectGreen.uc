class Link3TurretBeamEffectGreen extends ONSTurretBeamEffect;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=BeamEmitter'LinkVehiclesOmni.Link3TurretBeamEffectGreen.BeamEmitter4'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter5
         ...
         StartVelocityRange=(X=(Min=500.000000,Max=500.000000))
     End Object
     Emitters(1)=BeamEmitter'LinkVehiclesOmni.Link3TurretBeamEffectGreen.BeamEmitter5'
     ...
     End Object
     Emitters(2)=SpriteEmitter'LinkVehiclesOmni.Link3TurretBeamEffectGreen.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         ColorScale(1)=(RelativeTime=0.200000,Color=(B=83,G=140,R=55))
         ColorScale(2)=(RelativeTime=0.650000,Color=(B=23,G=132))
     ...
     End Object
     Emitters(3)=SpriteEmitter'LinkVehiclesOmni.Link3TurretBeamEffectGreen.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=128,G=255))
         ColorScale(3)=(RelativeTime=1.000000)
         MaxParticles=4
         ...
         LifetimeRange=(Min=0.200000,Max=0.200000)
     End Object
     Emitters(4)=SpriteEmitter'LinkVehiclesOmni.Link3TurretBeamEffectGreen.SpriteEmitter2'
