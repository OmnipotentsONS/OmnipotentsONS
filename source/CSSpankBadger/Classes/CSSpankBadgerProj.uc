...
class CSSpankBadgerProj extends Projectile;

var int PawnMomentumTransfer;
var CSSpankBadgerProjectileEffect ONSShockBallEffect;
var() Sound PopSound;
...
function SuperExplosion()
{
	...
	Spawn(class'CSSpankBadger.CSSpankBadgerProjectileExplosion');
...
function UltraExplosion()
{
    ...
    Spawn(class'CSSpankBadger.CSSpankBadgerUltraExplosion');
	if ( (Level.NetMode != NM_DedicatedServer) && EffectIsRelevant(Location,false) )
	{
		HitActor = Trace(HitLocation, HitNormal,Location - Vect(0,0,120), Location,false);
		if ( HitActor != None )
...
{
    if (DamageType == class'CSSpankBadgerDamTypeProj' 
...
defaultproperties
{
    ...
    TossZ=0.0
	DamageRadius=500.0
    PopSound=sound'CSSpankBadger.bigpop'
    UltraPopSound=sound'CSSpankBadger.hugepop'
    ...
    Skins(0)=None
    Texture=None
    MyDamageType=Class'CSSpankBadger.CSSpankBadgerDamTypeProj'
    AmbientGlow=255
