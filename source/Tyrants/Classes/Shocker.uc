class Shocker extends ONSWheeledCraft;
...
defaultproperties
{
     ...
     DeployedTPCamWorldOffset=(Z=320.000000)
     ...
     DriverWeapons(0)=(WeaponClass=Class'Tyrants.ShockerRocketPack',WeaponBone="RocketPackAttach")
     DriverWeapons(1)=(WeaponClass=Class'Tyrants.ShockerIonCannon',WeaponBone="maingunpostBase")
     PassengerWeapons(0)=(WeaponPawnClass=Class'Tyrants.ShockerFrontTurretPawn',WeaponBone="RightFrontgunAttach")
     PassengerWeapons(1)=(WeaponPawnClass=Class'Tyrants.ShockerFrontTurretPawn',WeaponBone="LeftFrontGunAttach")
     bHasAltFire=False
     ...
     End Object
     Wheels(0)=SVehicleWheel'Tyrants.Shocker.RightRearTIRe'
     ...
     Begin Object Class=SVehicleWheel Name=LeftRearTIRE
         ...
         WheelRadius=39.599998
     End Object
     Wheels(1)=SVehicleWheel'Tyrants.Shocker.LeftRearTIRE'
     ...
     Begin Object Class=SVehicleWheel Name=RightFrontTIRE
         ...
         WheelRadius=39.599998
     End Object
     Wheels(2)=SVehicleWheel'Tyrants.Shocker.RightFrontTIRE'
     ...
     Begin Object Class=SVehicleWheel Name=LeftFrontTIRE
         ...
         WheelRadius=39.599998
     End Object
     Wheels(3)=SVehicleWheel'Tyrants.Shocker.LeftFrontTIRE'
     ...
     End Object
     KParams=KarmaParamsRBFull'Tyrants.Shocker.KParams0'
