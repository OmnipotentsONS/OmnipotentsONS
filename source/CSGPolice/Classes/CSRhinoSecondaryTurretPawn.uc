...
class CSRhinoSecondaryTurretPawn extends ONSWeaponPawn;
...
defaultproperties
{
	VehiclePositionString="in a Rhino turret"
	VehicleNameString="Rhino Turret"
	EntryPosition=(X=0,Y=0,Z=0)
	EntryRadius=130.0
	ExitPositions(0)=(X=0,Y=-200,Z=100)
	ExitPositions(1)=(X=0,Y=200,Z=100)
	GunClass=class'CSGPolice.CSRhinoSecondaryTurret'
	CameraBone=Object02
