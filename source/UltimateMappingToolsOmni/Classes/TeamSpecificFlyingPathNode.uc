// ============================================================================
// TeamSpecificFlyingPathNode_v2, v2.0 @ 14-11-2005 13:33:37
...
// variable bBlocked is set to true, all bots will always ignore the pathnode.
//
...
//=============================================================================
class TeamSpecificFlyingPathNode extends FlyingPathNode
   placeable;
...
// Variables
//=============================================================================
var() int  BelongsToTeam; // To which team this FlyingPathNode belongs
