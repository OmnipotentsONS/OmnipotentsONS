...
// $ckr3: Release date: 15.08.2011 00:42:03 in Package: UltimateMappingTools$
//
// Triggers an Event if BOTH conditions are True.
// Untriggers it, if an Event had been triggered and one
// condition became False again.
//-----------------------------------------------------------------------------
class LogicalAND extends LogicGate
    placeable;
...
defaultproperties
{
     Texture=Texture'UltimateMappingTools_Tex.Icons.AND_Icon'
}
