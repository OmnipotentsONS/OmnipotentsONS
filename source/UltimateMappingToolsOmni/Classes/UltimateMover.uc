...
class UltimateMover extends Mover;
...
// checks, spawns UltimateProbeEvents for Tag (which is cleared afterwards) and
    ...
    default:
      if (AlternateTag != '') {
        if (NumKeysPrimary < NumKeys) {
          ...
          if (!IsA('UltimateClientMover') || Level.NetMode != NM_DedicatedServer) {
            // catch the alternate event
            ProbeEvent = Spawn(class'UltimateProbeEvent', Self, AlternateTag);
      ...
      if (PrimaryTag != '') {
        if (NumKeysPrimary > 1) {
          if (!IsA('UltimateClientMover') || Level.NetMode != NM_DedicatedServer) {
            ...
            ProbeEvent = Spawn(class'UltimateProbeEvent', Self, PrimaryTag);
...
function SetGroupMovement(bool bNewAlternateMovement)
{
  ...
  if (bIsLeader || Leader == Self) {
    for (M = Self; M != None; M = M.Follower) {
      if (UltimateMover(M) != None)
        UltimateMover(M).bAlternateMovement = bNewAlternateMovement;
    }
  }
}
...
defaultproperties
{
     NumKeysPrimary=2
     CloseTime=1.000000
     AlternateCloseTime=1.000000
     AlternateMoveTime=1.000000
     AlternateStayOpenTime=4.000000
     TimeMultipliersClose(0)=1.000000
     TimeMultipliersClose(1)=1.000000
     TimeMultipliersClose(2)=1.000000
     TimeMultipliersClose(3)=1.000000
     TimeMultipliersClose(4)=1.000000
     TimeMultipliersClose(5)=1.000000
     TimeMultipliersClose(6)=1.000000
     TimeMultipliersClose(7)=1.000000
     TimeMultipliersClose(8)=1.000000
     TimeMultipliersClose(9)=1.000000
     TimeMultipliersClose(10)=1.000000
     TimeMultipliersClose(11)=1.000000
     TimeMultipliersClose(12)=1.000000
     TimeMultipliersClose(13)=1.000000
     TimeMultipliersClose(14)=1.000000
     TimeMultipliersClose(15)=1.000000
     TimeMultipliersClose(16)=1.000000
     TimeMultipliersClose(17)=1.000000
     TimeMultipliersClose(18)=1.000000
     TimeMultipliersClose(19)=1.000000
     TimeMultipliersClose(20)=1.000000
     TimeMultipliersClose(21)=1.000000
     TimeMultipliersClose(22)=1.000000
     TimeMultipliersClose(23)=1.000000
     TimeMultipliersOpen(0)=1.000000
     TimeMultipliersOpen(1)=1.000000
     TimeMultipliersOpen(2)=1.000000
     TimeMultipliersOpen(3)=1.000000
     TimeMultipliersOpen(4)=1.000000
     TimeMultipliersOpen(5)=1.000000
     TimeMultipliersOpen(6)=1.000000
     TimeMultipliersOpen(7)=1.000000
     TimeMultipliersOpen(8)=1.000000
     TimeMultipliersOpen(9)=1.000000
     TimeMultipliersOpen(10)=1.000000
     TimeMultipliersOpen(11)=1.000000
     TimeMultipliersOpen(12)=1.000000
     TimeMultipliersOpen(13)=1.000000
     TimeMultipliersOpen(14)=1.000000
     TimeMultipliersOpen(15)=1.000000
     TimeMultipliersOpen(16)=1.000000
     TimeMultipliersOpen(17)=1.000000
     TimeMultipliersOpen(18)=1.000000
     TimeMultipliersOpen(19)=1.000000
     TimeMultipliersOpen(20)=1.000000
     TimeMultipliersOpen(21)=1.000000
     TimeMultipliersOpen(22)=1.000000
     TimeMultipliersOpen(23)=1.000000
}
