class AuroraSkyMine extends ShockProjectile;
...
{
	if (DamageType == class'AuroraLaser')
	{
...
function SuperExplosion()
{
	...
	HurtRadius(ComboDamage, ComboRadius, class'AuroraCombo', ComboMomentumTransfer, Location );

	E = Spawn(class'AuroraComboEffect');
	if ( Level.NetMode == NM_DedicatedServer )
	{
		if ( E != None )
			E.LifeSpan = 0.25;
