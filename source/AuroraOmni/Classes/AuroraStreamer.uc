class AuroraStreamer extends Emitter;
...
defaultproperties
{
     Begin Object Class=TrailEmitter Name=TrailEmitter0
         ...
         ColorScale(0)=(Color=(B=64,G=128,R=64,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=64,G=128,R=64,A=255))
         MaxParticles=1
     ...
     End Object
     Emitters(0)=TrailEmitter'AuroraOmni.AuroraStreamer.TrailEmitter0'
