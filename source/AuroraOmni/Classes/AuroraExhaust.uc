class AuroraExhaust extends Emitter
	placeable;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter2
         ...
         SpinParticles=True
         UniformSize=True
         ColorScale(1)=(RelativeTime=0.330000,Color=(B=130,G=255,R=130))
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=130,G=255,R=130))
     ...
     End Object
     Emitters(0)=MeshEmitter'AuroraOmni.AuroraExhaust.MeshEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         ColorScale(1)=(RelativeTime=0.125000,Color=(B=28,G=192,R=10))
         ColorScale(2)=(RelativeTime=0.400000,Color=(B=26,G=200,R=150))
         ColorScale(3)=(RelativeTime=1.000000)
         CoordinateSystem=PTCS_Relative
         MaxParticles=30
     ...
     End Object
     Emitters(1)=SpriteEmitter'AuroraOmni.AuroraExhaust.SpriteEmitter3'
