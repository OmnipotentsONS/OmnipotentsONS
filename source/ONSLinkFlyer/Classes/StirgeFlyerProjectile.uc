...
simulated function PostBeginPlay()
{
    ...
    if ( Level.NetMode != NM_DedicatedServer )
        Plasma = Spawn(class'Stirge_PurplePlasma', Self,, Location - 50*Dir, Rotation);
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    {
     Spawn(class'StirgeProjSparksPurple',,, HitLocation, rotator(HitNormal));
     FX_Impact = Spawn(class'FX_StirgePurplePlasmaImpact',,, HitLocation + HitNormal * 2, rotator(HitNormal));   
