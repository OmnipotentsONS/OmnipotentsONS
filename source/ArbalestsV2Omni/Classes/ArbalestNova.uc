...
//
//-----------------------------------------------------------
class ArbalestNova extends ONSTreadCraft;
...
simulated function DrawHUD(Canvas Canvas)
{
	...
	if (Weapons[0]!=none)
	{
		CoPilot = ArbalestRocketLauncherNova(weapons[0]).FireModeNames[ArbalestRocketLauncherNova(weapons[0]).Firemode-1];
...
simulated function UpdatePrecacheMaterials()
{
    ...
    Level.AddPrecacheMaterial(Material'Arbalests_Tex.ArbalestNova.ArbalestNovaRed');
    Level.AddPrecacheMaterial(Material'Arbalests_Tex.ArbalestNova.ArbalestNovaBlue');
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'ArbalestsV2Omni.ArbalestRocketLauncherNova',WeaponBone="TankCannonWeapon")
     RedSkin=Texture'Arbalests_Tex.ArbalestNova.ArbalestNovaRed'
     BlueSkin=Texture'Arbalests_Tex.ArbalestNova.ArbalestNovaBlue'
     ...
     Begin Object Class=KarmaParamsRBFull Name=KParams0
         ...
         KFriction=0.500000
     End Object
     KParams=KarmaParamsRBFull'ArbalestsV2Omni.ArbalestNova.KParams0'
