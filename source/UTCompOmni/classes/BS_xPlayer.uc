...
simulated function bool IsIgnoredDamageSound(class<DamageType> DamageType)
{
    local int i;
    ...
    for(i=0;i<IgnoredHitSounds.Length;i++)
    {
        if(string(DamageType.Name) == IgnoredHitSounds[i])
            return true;
    }
