...
DefaultProperties
{
     ...
     WeaponClassNames(0)="UTCompOmni.Forward_NewNet_ShockRifle"
     WeaponClassNames(1)="UTCompOmni.Forward_NewNet_LinkGun"
     WeaponClassNames(2)="UTCompOmni.Forward_NewNet_MiniGun"
     WeaponClassNames(3)="UTCompOmni.Forward_NewNet_FlakCannon"
     WeaponClassNames(4)="UTCompOmni.Forward_NewNet_RocketLauncher"
     WeaponClassNames(5)="UTCompOmni.Forward_NewNet_SniperRifle"
     WeaponClassNames(6)="UTCompOmni.Forward_NewNet_BioRifle"
     WeaponClassNames(7)="UTCompOmni.Forward_NewNet_AssaultRifle"
     WeaponClassNames(8)="UTCompOmni.Forward_NewNet_SniperRifle"
     WeaponClassNames(9)="UTCompOmni.NewNet_ONSAVRiL"
     WeaponClassNames(10)="UTCompOmni.NewNet_ONSMineLayer"
     WeaponClassNames(11)="UTCompOmni.NewNet_ONSGrenadeLauncher"

     AltWeaponClassNames(0)="UTCompOmni.Forward_UTComp_ShockRifle"
     AltWeaponClassNames(1)="UTCompOmni.Forward_UTComp_LinkGun"
     AltWeaponClassNames(2)="UTCompOmni.Forward_UTComp_MiniGun"
     AltWeaponClassNames(3)="UTCompOmni.Forward_UTComp_FlakCannon"
     AltWeaponClassNames(4)="UTCompOmni.Forward_UTComp_RocketLauncher"
     AltWeaponClassNames(5)="UTCompOmni.Forward_UTComp_SniperRifle"
     AltWeaponClassNames(6)="UTCompOmni.Forward_UTComp_BioRifle"
     AltWeaponClassNames(7)="UTCompOmni.Forward_UTComp_AssaultRifle"
     AltWeaponClassNames(8)="UTCompOmni.Forward_UTComp_SniperRifle"
     ...
     NewNetWeaponClassNames(0)="UTCompOmni.NewNet_ShockRifle"
     NewNetWeaponClassNames(1)="UTCompOmni.NewNet_LinkGun"
     NewNetWeaponClassNames(2)="UTCompOmni.NewNet_MiniGun"
     NewNetWeaponClassNames(3)="UTCompOmni.NewNet_FlakCannon"
     NewNetWeaponClassNames(4)="UTCompOmni.NewNet_RocketLauncher"
     NewNetWeaponClassNames(5)="UTCompOmni.NewNet_SniperRifle"
     NewNetWeaponClassNames(6)="UTCompOmni.NewNet_BioRifle"
     NewNetWeaponClassNames(7)="UTCompOmni.NewNet_AssaultRifle"
     NewNetWeaponClassNames(8)="UTCompOmni.NewNet_ClassicSniperRifle"
     NewNetWeaponClassNames(9)="UTCompOmni.NewNet_ONSAVRiL"
     NewNetWeaponClassNames(10)="UTCompOmni.NewNet_ONSMineLayer"
     NewNetWeaponClassNames(11)="UTCompOmni.NewNet_ONSGrenadeLauncher"

     UTCompWeaponClassNames(0)="UTCompOmni.UTComp_ShockRifle"
     UTCompWeaponClassNames(1)="UTCompOmni.UTComp_LinkGun"
     UTCompWeaponClassNames(2)="UTCompOmni.UTComp_MiniGun"
     UTCompWeaponClassNames(3)="UTCompOmni.UTComp_FlakCannon"
     UTCompWeaponClassNames(4)="UTCompOmni.UTComp_RocketLauncher"
     UTCompWeaponClassNames(5)="UTCompOmni.UTComp_SniperRifle"
     UTCompWeaponClassNames(6)="UTCompOmni.UTComp_BioRifle"
     UTCompWeaponClassNames(7)="UTCompOmni.UTComp_AssaultRifle"
     UTCompWeaponClassNames(8)="UTCompOmni.UTComp_ClassicSniperRifle"
     UTCompWeaponClassNames(9)="UTCompOmni.UTComp_ONSAVRiL"
     UTCompWeaponClassNames(10)="UTCompOmni.UTComp_ONSMineLayer"
     UTCompWeaponClassNames(11)="UTCompOmni.UTComp_ONSGrenadeLauncher"
