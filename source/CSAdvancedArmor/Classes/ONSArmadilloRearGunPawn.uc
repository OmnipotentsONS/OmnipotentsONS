...
//
//-----------------------------------------------------------
class ONSArmadilloRearGunPawn extends ONSWeaponPawn;
...
defaultproperties
{
     GunClass=Class'CSAdvancedArmor.ONSArmadilloRearGun'
     bHasAltFire=False
     CameraBone="Object02"
     ...
     VehiclePositionString="in a Armadillo's rear turret"
     VehicleNameString="Armadillo Rear Turret"
}
