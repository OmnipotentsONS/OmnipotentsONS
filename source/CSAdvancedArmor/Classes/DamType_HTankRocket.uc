class DamType_HTankRocket extends VehicleDamageType
	abstract;
...
defaultproperties
{
     VehicleClass=Class'CSAdvancedArmor.ONSHurricaneTank'
     DeathString="%k's tank rocket blew %o into flaming bits."
