class KingHellHoundSideGunPawn extends ONSWeaponPawn;
...
defaultproperties
{
     GunClass=Class'CSKingHellHound.KingHellHoundSideGun'
     ...
     VehiclePositionString="in a King HellHound's side turret"
     VehicleNameString="King HellHound Side Turret"
}
