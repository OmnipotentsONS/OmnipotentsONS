class KingHellHoundDriverWeapon extends ONSWeapon;
...
defaultproperties
{
     ...
     ProjectileClass=Class'CSKingHellHound.KingHellHoundFlakChunk'
     AltFireProjectileClass=Class'CSKingHellHound.KingHellHoundFlakShell'
