class KingHellHoundSideGun extends ONSWeapon;

#exec OBJ LOAD FILE=..\Animations\ONSWeapons-A.ukx

var class<ShockBeamEffect> BeamEffectClass;
var KingHellHoundSkyMine ComboTarget;
var float MinAim;
...
function SetComboTarget(KingHellHoundSkyMine S)
{
...
state InstantFireMode
{
    ...
    {
    	local KingHellHoundSkyMine S;

    	S = KingHellHoundSkyMine(SpawnProjectile(ProjectileClass, False));
...
defaultproperties
{
     ...
     DamageType=Class'CSKingHellHound.KingHellHoundLaser'
     DamageMin=40
     DamageMax=40
     ProjectileClass=Class'CSKingHellHound.KingHellHoundSkyMine'
