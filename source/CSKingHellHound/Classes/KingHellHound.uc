class KingHellHound extends ONSWheeledcraft
      placeable;
...
#exec OBJ LOAD FILE=..\textures\KingHound_TEX.utx
...
static function StaticPrecache(LevelInfo L)
{
    ...
    L.AddPrecacheMaterial(Material'KingHound_TEX.KingHellHoundRed');
    L.AddPrecacheMaterial(Material'KingHound_TEX.KingHellHoundBlue');
...
simulated function UpdatePrecacheMaterials()
{
    ...
    Level.AddPrecacheMaterial(Material'KingHound_TEX.KingHellHoundRed');
    Level.AddPrecacheMaterial(Material'KingHound_TEX.KingHellHoundBlue');
...
//     TorqueCurve=(Points=((OutVal=9.000000),(InVal=200.000000,OutVal=10.000000),(InVal=1500.000000,OutVal=11.000000),(InVal=2500.000000)))
     ...
     DriverWeapons(0)=(WeaponClass=Class'CSKingHellHound.KingHellHoundDriverWeapon',WeaponBone="Dummy01")
     PassengerWeapons(0)=(WeaponPawnClass=Class'CSKingHellHound.KingHellHoundSideGunPawn',WeaponBone="Dummy01")
     PassengerWeapons(1)=(WeaponPawnClass=Class'CSKingHellHound.KingHellHoundRearTurretPawn',WeaponBone="Dummy02")
     RedSkin=Texture'KingHound_TEX.KingHellHoundRed'
     BlueSkin=Texture'KingHound_TEX.KingHellHoundBlue'
     IdleSound=Sound'GorzWheels_Sounds.KingHellHound.KingHHEngine'
     ...
     HeadlightCoronaMaterial=Texture'KingHound_TEX.KingHellHoundFlashFlare'
     HeadlightCoronaMaxSize=100.000000
     HeadlightProjectorMaterial=Texture'KingHound_TEX.KingHellHoundProjector'
     ...
     End Object
     Wheels(0)=SVehicleWheel'CSKingHellHound.KingHellHound.RRWheel'
     ...
     End Object
     Wheels(1)=SVehicleWheel'CSKingHellHound.KingHellHound.LRWheel'
     ...
     End Object
     Wheels(2)=SVehicleWheel'CSKingHellHound.KingHellHound.RFWheel'
     ...
     End Object
     Wheels(3)=SVehicleWheel'CSKingHellHound.KingHellHound.LFWheel'
     ...
     End Object
     KParams=KarmaParamsRBFull'CSKingHellHound.KingHellHound.KarmaParamsRBFull1'
