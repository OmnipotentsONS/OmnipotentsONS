class KingHellHoundRearTurretPawn extends ONSWeaponPawn;
...
defaultproperties
{
     GunClass=Class'CSKingHellHound.KingHellHoundRearGunTurret'
     bHasAltFire=False
     ...
     VehiclePositionString="in a King HellHound rear turret"
     VehicleNameString="King HellHound Rear Turret"
}
