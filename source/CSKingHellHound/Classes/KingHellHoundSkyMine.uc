class KingHellHoundSkyMine extends ShockProjectile;
...
function SuperExplosion()
{
	...
	HurtRadius(ComboDamage, ComboRadius, class'KingHellHoundCombo', ComboMomentumTransfer, Location );

	E = Spawn(class'KingHellHoundComboEffect');
	if ( Level.NetMode == NM_DedicatedServer )
	{
		if ( E != None )
			E.LifeSpan = 0.25;
...
defaultproperties
{
     ...
     ProjectileEffectClass=Class'CSKingHellHound.KingHellHoundSkyMineEffect'
     ComboDamage=300.000000
     ComboRadius=725.000000
     ComboDamageType=Class'CSKingHellHound.KingHellHoundLaser'
     Speed=1800.000000
     MaxSpeed=1800.000000
     Damage=50.000000
     MomentumTransfer=25000.000000
     MyDamageType=Class'CSKingHellHound.KingHoundSkyMine'
     DrawType=DT_None
     DrawScale=1.050000
     Style=STY_Additive
