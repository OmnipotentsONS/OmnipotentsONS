...
//
//--------------------------------------------------------------
class KrakenRocketTrailEffect extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'CSKraken.KrakenRocketTrailEffect.SpriteEmitter8'
     ...
     End Object
     Emitters(1)=SpriteEmitter'CSKraken.KrakenRocketTrailEffect.SpriteEmitter9'
