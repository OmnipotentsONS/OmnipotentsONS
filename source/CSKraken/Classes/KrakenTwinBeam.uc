...
//
//-----------------------------------------------------------
class KrakenTwinBeam extends ONSWeapon;

#exec OBJ LOAD FILE=..\Animations\ONSWeapons-A.ukx

var class<KrakenPowerBeamEffect> BeamEffectClass;
...
{
	local KrakenPowerBeamEffect Beam;
...
defaultproperties
{
     BeamEffectClass=Class'CSKraken.KrakenPowerBeamEffect'
     ...
     DamageType=Class'CSKraken.KrakenPowerBeam'
     DamageMin=300
     DamageMax=300
