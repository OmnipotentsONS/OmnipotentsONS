class KrakenPowerBeamEffect extends Emitter;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter0
         ...
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=128,G=100,R=255))
     ...
     End Object
     Emitters(0)=BeamEmitter'CSKraken.KrakenPowerBeamEffect.BeamEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=255,G=64,R=255))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=60,G=255,R=255))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.400000
         MaxParticles=1
         StartLocationOffset=(Y=-10.000000)
     ...
     End Object
     Emitters(1)=BeamEmitter'CSKraken.KrakenPowerBeamEffect.BeamEmitter1'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter2
         ...
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=255,G=100,R=128))
         ColorScale(2)=(RelativeTime=1.000000)
         MaxParticles=1
         StartLocationOffset=(Y=10.000000)
         UseRotationFrom=PTRS_Actor
         ...
         LifetimeRange=(Min=0.450000,Max=0.450000)
     End Object
     Emitters(2)=BeamEmitter'CSKraken.KrakenPowerBeamEffect.BeamEmitter2'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter3
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=64,G=64,R=150))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=192,G=100,R=192))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.400000
         MaxParticles=1
         StartLocationOffset=(Y=10.000000)
         ...
         LifetimeRange=(Min=0.600000,Max=0.600000)
     End Object
     Emitters(3)=BeamEmitter'CSKraken.KrakenPowerBeamEffect.BeamEmitter3'
