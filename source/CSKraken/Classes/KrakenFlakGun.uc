...
// Kraken Flak Gun
//=============================================================================
class KrakenFlakGun extends ONSWeapon;
...
defaultproperties
{
     ...
     DamageType=Class'CSKraken.KrakenFlak'
     ProjectileClass=Class'CSKraken.Kraken_Flak'
     AltFireProjectileClass=Class'CSKraken.Kraken_Flak'
