class AlligatorSecondaryGun extends ONSWeapon;

#exec OBJ LOAD FILE=..\Animations\ONSWeapons-A.ukx

var class<AlligatorChargeBeamEffect> BeamEffectClass;
...
{
	local AlligatorChargeBeamEffect Beam;
...
defaultproperties
{
     BeamEffectClass=Class'CSAlligator.AlligatorChargeBeamEffect'
     MaxHoldTime=2.990000
     ...
     bDoOffsetTrace=True
     RedSkin=Texture'Reptiles_Tex.Alligator.AlligatorBlue'
     BlueSkin=Texture'Reptiles_Tex.Alligator.AlligatorRed'
     FireInterval=0.750000
     FlashEmitterClass=Class'CSAlligator.AlligatorSecondaryGunCharge'
     FireSoundClass=Sound'CuddlyArmor_Sound.Alligator.AlligatorBeam'
     FireSoundVolume=1230.000000
     FireForce="PRVRearFire"
     DamageType=Class'CSAlligator.DamTypeAlligatorBeam'
     DamageMin=300
     DamageMax=300
