class AlligatorChargeBeamEffect extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=BeamEmitter'CSAlligator.AlligatorChargeBeamEffect.BeamEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         ColorScale(1)=(RelativeTime=0.800000,Color=(G=128,R=192))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.400000
         MaxParticles=1
         StartLocationOffset=(Y=-7.000000)
     ...
     End Object
     Emitters(1)=BeamEmitter'CSAlligator.AlligatorChargeBeamEffect.BeamEmitter1'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter2
         ...
         ColorScale(0)=(Color=(G=192,R=192))
         ColorScale(1)=(RelativeTime=0.800000,Color=(G=128,R=255))
         ColorScale(2)=(RelativeTime=2.000000)
         MaxParticles=1
         ...
         LifetimeRange=(Min=0.450000,Max=0.450000)
     End Object
     Emitters(2)=BeamEmitter'CSAlligator.AlligatorChargeBeamEffect.BeamEmitter2'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter3
         ...
         LifetimeRange=(Min=0.600000,Max=0.600000)
     End Object
     Emitters(3)=BeamEmitter'CSAlligator.AlligatorChargeBeamEffect.BeamEmitter3'
