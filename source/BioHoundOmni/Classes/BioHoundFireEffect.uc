class BioHoundFireEffect extends Emitter;
...
*/
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=3,G=155,R=1))
         ColorScale(1)=(RelativeTime=1.000000)
         MaxParticles=3
     ...
     End Object
     Emitters(4)=SpriteEmitter'BioHoundOmni.BioHoundFireEffect.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=55,G=125,R=2))
         ColorScale(1)=(RelativeTime=1.000000)
         MaxParticles=3
     ...
     End Object
     Emitters(5)=SpriteEmitter'BioHoundOmni.BioHoundFireEffect.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=5,G=155,R=55))
         ColorScale(1)=(RelativeTime=1.000000)
         MaxParticles=3
         ...
         StartVelocityRange=(X=(Min=20.000000,Max=25.000000))
     End Object
     Emitters(6)=SpriteEmitter'BioHoundOmni.BioHoundFireEffect.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=25,G=155,R=5))
         ColorScale(1)=(RelativeTime=1.000000)
         MaxParticles=3
         ...
         StartVelocityRange=(X=(Min=20.000000,Max=25.000000))
     End Object
     Emitters(7)=SpriteEmitter'BioHoundOmni.BioHoundFireEffect.SpriteEmitter3'
