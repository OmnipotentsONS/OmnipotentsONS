class BioHoundSideGun extends ONSWeapon;

#exec OBJ LOAD FILE=..\Animations\ONSWeapons-A.ukx

var class<ShockBeamEffect> BeamEffectClass;
var BioHoundSkyMine ComboTarget;
var float MinAim;
...
function SetComboTarget(BioHoundSkyMine S)
{
...
state InstantFireMode
{
    ...
    {
    	local BioHoundSkyMine S;

    	S = BioHoundSkyMine(SpawnProjectile(ProjectileClass, False));
...
defaultproperties
{
     ...
     DamageType=Class'BioHoundOmni.BioHoundLaser'
     DamageMin=32
     DamageMax=32
     ProjectileClass=Class'BioHoundOmni.BioHoundSkyMine'
