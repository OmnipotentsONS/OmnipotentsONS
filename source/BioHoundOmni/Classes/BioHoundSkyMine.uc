class BioHoundSkyMine extends ShockProjectile;
...
{
	if (DamageType == class'BioHoundLaser')
	{
...
function SuperExplosion()
{
	...
	HurtRadius(ComboDamage, ComboRadius, class'BioHoundCombo', ComboMomentumTransfer, Location );

	E = Spawn(class'BioHoundComboEffect');
	if ( Level.NetMode == NM_DedicatedServer )
	{
		if ( E != None )
			E.LifeSpan = 0.25;
...
defaultproperties
{
     ...
     MaxChainReactionDist=5000.000000
     ChainReactionDelay=0.600000
     BeamEffectClass=Class'XWeapons.ShockBeamEffect'
     ProjectileEffectClass=Class'BioHoundOmni.BioHoundSkyMineEffect'
     ComboDamage=250.000000
     ComboRadius=600.000000
     ComboDamageType=Class'BioHoundOmni.BioHoundCombo'
     Speed=1300.000000
     MaxSpeed=3000.000000
     Damage=40.000000
     MomentumTransfer=25000.000000
     MyDamageType=Class'BioHoundOmni.BioHoundSkyMineKill'
     DrawType=DT_None
     DrawScale=1.050000
     Style=STY_Additive
