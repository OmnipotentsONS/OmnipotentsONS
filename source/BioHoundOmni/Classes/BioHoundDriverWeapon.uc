class BioHoundDriverWeapon extends ONSWeapon;
...
defaultproperties
{
     ...
     WeaponFireOffset=20.00000
     FireInterval=0.50000
     AltFireInterval=1.800000
     ...
     ProjectileClass=Class'BioHoundOmni.BioHoundGlob'
     AltFireProjectileClass=Class'BioHoundOmni.BioHoundGlob'
