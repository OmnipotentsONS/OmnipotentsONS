class BioHoundBeamEffect extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=BeamEmitter'BioHoundOmni.BioHoundBeamEffect.BeamEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=35,G=125))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.800000
         MaxParticles=1
         StartLocationOffset=(Y=12.000000)
         ...
         StartVelocityRange=(X=(Min=500.000000,Max=500.000000))
     End Object
     Emitters(1)=BeamEmitter'BioHoundOmni.BioHoundBeamEffect.BeamEmitter1'
     ...
     End Object
     Emitters(2)=SpriteEmitter'BioHoundOmni.BioHoundBeamEffect.SpriteEmitter17'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter19
         ...
         ColorScale(1)=(RelativeTime=0.650000,Color=(B=52,G=162))
         ColorScale(2)=(RelativeTime=1.000000)
         MaxParticles=8
     ...
     End Object
     Emitters(3)=SpriteEmitter'BioHoundOmni.BioHoundBeamEffect.SpriteEmitter19'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter20
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=32,G=178,R=128))
         ...
         LifetimeRange=(Min=0.200000,Max=0.200000)
     End Object
     Emitters(4)=SpriteEmitter'BioHoundOmni.BioHoundBeamEffect.SpriteEmitter20'
