class BioHound extends ONSWheeledcraft
      placeable;
...
#exec OBJ LOAD FILE=..\textures\BioHound_Tex.utx
...
static function StaticPrecache(LevelInfo L)
{
    ...
    L.AddPrecacheMaterial(Material'BioHound_Tex.BioHound.BioHoundRed');
    L.AddPrecacheMaterial(Material'BioHound_Tex.BioHound.BioHoundBlue');
...
simulated function UpdatePrecacheMaterials()
{
    ...
    Level.AddPrecacheMaterial(Material'BioHound_Tex.BioHound.BioHoundRed');
    Level.AddPrecacheMaterial(Material'BioHound_Tex.BioHound.BioHoundBlue');
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'BioHoundOmni.BioHoundDriverWeapon',WeaponBone="Dummy01")
     PassengerWeapons(0)=(WeaponPawnClass=Class'BioHoundOmni.BioHoundSideGunPawn',WeaponBone="Dummy01")
     PassengerWeapons(1)=(WeaponPawnClass=Class'BioHoundOmni.BioHoundRearGunPawn',WeaponBone="Dummy02")
     ...
     HeadlightCoronaMaterial=Texture'BioHound_Tex.BioHound.BioHoundFlashFlare'
     HeadlightCoronaMaxSize=100.000000
     HeadlightProjectorMaterial=Texture'BioHound_Tex.BioHound.BioHoundProjector'
     ...
     End Object
     Wheels(0)=SVehicleWheel'BioHoundOmni.BioHound.SVehicleWheel4'
     ...
     End Object
     Wheels(1)=SVehicleWheel'BioHoundOmni.BioHound.SVehicleWheel5'
     ...
     End Object
     Wheels(2)=SVehicleWheel'BioHoundOmni.BioHound.SVehicleWheel6'
     ...
     End Object
     Wheels(3)=SVehicleWheel'BioHoundOmni.BioHound.SVehicleWheel7'
     ...
     TPCamWorldOffset=(X=40.000000,Z=155.000000)
     DriverDamageMult=0.000000
     VehiclePositionString="in a BioHound"
     VehicleNameString="BioHound 2.0"
     RanOverDamageType=Class'BioHoundOmni.BioHoundRoadkill'
     MomentumMult=2.00000 // reduce knockaround default is 4.000
     HornSounds(0)=Sound'GorzWheels_Sounds.HellHound.HHHorn0'
     HornSounds(1)=Sound'ONSVehicleSounds-S.Horns.Horn01'
     HealthMax=633.000000
     Health=633
     ...
     End Object
     KParams=KarmaParamsRBFull'BioHoundOmni.BioHound.KarmaParamsRBFull1'
