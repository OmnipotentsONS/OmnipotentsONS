class BioHoundSideGunPawn extends ONSWeaponPawn;
...
defaultproperties
{
     GunClass=Class'BioHoundOmni.BioHoundSideGun'
     ...
     VehiclePositionString="in a BioHound's side turret"
     VehicleNameString="BioHound Side Turret"
}
