class FlakRatOmniMortar extends ONSWeapon;
...
defaultproperties
{
     ...
     ProjectileClass=Class'FlakRatOmni.FlakRatOmniShell'
     AltFireProjectileClass=Class'FlakRatOmni.FlakRatOmniMortarShell'
