class ShockerIonCannon extends ONSHoverTankCannon;

var()	class<FX_Turret_IonCannon_BeamFire> BeamEffectClass;
var()	class<FX_ShockerCannon_AimLaser> RedBeamClass;
var()	class<FX_ShockerCannon_AimLaser> BlueBeamClass;
...
var	FX_ShockerCannon_AimLaser	AimLaser;
...
function SpawnLaserBeam()
{
	...
	if (Instigator.GetTeamNum() == 1)
		AimLaser = Spawn(BlueBeamClass, Self,, WeaponFireLocation, WeaponFireRotation);
	else
    	AimLaser = Spawn(RedBeamClass, Self,, WeaponFireLocation, WeaponFireRotation);
}
...
defaultproperties
{
     BeamEffectClass=Class'Shocker_V2.Shocker_IonPlasma_BeamFire'
     RedBeamClass=Class'Shocker_V2.FX_ShockerCannon_AimLaser'
     BlueBeamClass=Class'Shocker_V2.FX_ShockerCannon_AimLaser_Blue'
