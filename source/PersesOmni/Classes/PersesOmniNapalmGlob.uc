...
class PersesOmniNapalmGlob extends Projectile;
...
var PersesOmniNapalmGlobFlames Trail;
...
simulated function PostNetBeginPlay()
{
	...
	{
		Trail = Spawn(class'PersesOmniNapalmGlobFlames', Self);
	}
}
...
auto simulated state Flying
{
	simulated function Landed(vector HitNormal)
	{
		...
		Spawn(class'PersesOmniNapalmScorch',,,, rotator(-HitNormal));
...
defaultproperties
{
     ...
     Damage=7.25000
     MyDamageType=Class'PersesOmni.DamTypePersesOmniNapalmGlob'
