...
class PersesOmniArtilleryAirExplosion extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=FlashMesh
         StaticMesh=StaticMesh'UT3SPMAEffects.ArtilleryEffects.SPMAAirExplosionMesh'
     ...
     End Object
     Emitters(0)=MeshEmitter'PersesOmni.PersesOmniArtilleryAirExplosion.FlashMesh'
     ...
     End Object
     Emitters(1)=SpriteEmitter'PersesOmni.PersesOmniArtilleryAirExplosion.ExplosionSprite'
     ...
     End Object
     Emitters(2)=SpriteEmitter'PersesOmni.PersesOmniArtilleryAirExplosion.GlowSprite'
     ...
     Begin Object Class=SpriteEmitter Name=Sparks
         ...
         InitialParticlesPerSecond=1000.000000
         DrawStyle=PTDS_Brighten
         Texture=Texture'PersesOmni_Tex.Artillery.ArtilleryEffectsSPMASpark'
         SecondsBeforeInactive=0.000000
     ...
     End Object
     Emitters(3)=SpriteEmitter'PersesOmni.PersesOmniArtilleryAirExplosion.Sparks'
