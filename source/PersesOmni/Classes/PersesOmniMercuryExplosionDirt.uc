...
class PersesOmniMercuryExplosionDirt extends PersesOmniMercuryExplosion;
...
defaultproperties
{
     ...
     End Object
     Emitters(2)=SpriteEmitter'PersesOmni.PersesOmniMercuryExplosionDirt.ExplosionChunks'
