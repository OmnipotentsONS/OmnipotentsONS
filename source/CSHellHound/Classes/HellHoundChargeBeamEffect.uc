class HellHoundChargeBeamEffect extends Emitter;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter0
         ...
         ColorScale(0)=(Color=(B=200,G=128,R=255))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=200,G=32,R=255))
     ...
     End Object
     Emitters(0)=BeamEmitter'CSHellHound.HellHoundChargeBeamEffect.BeamEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=100,G=64,R=128))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=192,G=192,R=200))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.400000
         MaxParticles=1
         StartLocationOffset=(Y=-12.000000)
     ...
     End Object
     Emitters(1)=BeamEmitter'CSHellHound.HellHoundChargeBeamEffect.BeamEmitter1'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter2
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=140,G=64,R=192))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=192,G=128,R=255))
         ColorScale(2)=(RelativeTime=1.000000)
         MaxParticles=1
         StartLocationOffset=(Y=12.000000)
         UseRotationFrom=PTRS_Actor
         ...
         LifetimeRange=(Min=0.450000,Max=0.450000)
     End Object
     Emitters(2)=BeamEmitter'CSHellHound.HellHoundChargeBeamEffect.BeamEmitter2'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter3
         ...
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=100,G=64,R=128))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=128,G=64,R=230))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.400000
         MaxParticles=1
         StartLocationOffset=(Y=12.000000)
         ...
         LifetimeRange=(Min=0.600000,Max=0.600000)
     End Object
     Emitters(3)=BeamEmitter'CSHellHound.HellHoundChargeBeamEffect.BeamEmitter3'
