class HellHoundSideGunPawn extends ONSWeaponPawn;
...
defaultproperties
{
     GunClass=Class'CSHellHound.HellHoundSideGun'
     ...
     VehiclePositionString="in a HellHound's side turret"
     VehicleNameString="HellHound Side Turret"
}
