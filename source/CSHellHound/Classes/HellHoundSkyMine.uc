class HellHoundSkyMine extends ShockProjectile;
...
{
	if (DamageType == class'HellHoundLaser')
	{
...
function SuperExplosion()
{
	...
	HurtRadius(ComboDamage, ComboRadius, class'HellHoundCombo', ComboMomentumTransfer, Location );

	E = Spawn(class'HoundComboEffect');
	if ( Level.NetMode == NM_DedicatedServer )
	{
		if ( E != None )
			E.LifeSpan = 0.25;
...
defaultproperties
{
     ...
     ProjectileEffectClass=Class'CSHellHound.HoundSkyMineEffect'
     ComboRadius=590.000000
     ComboDamageType=Class'CSHellHound.HellHoundCombo'
     Speed=1300.000000
     MaxSpeed=3000.000000
     Damage=40.000000
     MomentumTransfer=25000.000000
     MyDamageType=Class'CSHellHound.HellHoundSkyMineKill'
     DrawType=DT_None
     DrawScale=1.050000
     Style=STY_Additive
