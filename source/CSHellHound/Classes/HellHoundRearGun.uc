class HellHoundRearGun extends ONSWeapon;

#exec OBJ LOAD FILE=..\Animations\ONSWeapons-A.ukx

var class<HellHoundChargeBeamEffect> BeamEffectClass;
...
{
	local HellHoundChargeBeamEffect Beam;
...
defaultproperties
{
     BeamEffectClass=Class'CSHellHound.HellHoundChargeBeamEffect'
     ...
     FireSoundClass=Sound'GorzWheels_Sounds.HellHound.HellHoundRearFire'
     FireForce="PRVRearFire"
     DamageType=Class'CSHellHound.HellHoundTwinbeam'
     DamageMin=300
     DamageMax=300
