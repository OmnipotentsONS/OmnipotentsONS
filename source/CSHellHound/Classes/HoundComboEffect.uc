class HoundComboEffect extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=MeshEmitter'CSHellHound.HoundComboEffect.MeshEmitter3'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter4
         ...
         InitialDelayRange=(Min=0.200000,Max=0.200000)
     End Object
     Emitters(1)=MeshEmitter'CSHellHound.HoundComboEffect.MeshEmitter4'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter5
         ...
         InitialDelayRange=(Min=0.200000,Max=0.200000)
     End Object
     Emitters(2)=MeshEmitter'CSHellHound.HoundComboEffect.MeshEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter7
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=171,R=171))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=203,R=158))
     ...
     End Object
     Emitters(3)=SpriteEmitter'CSHellHound.HoundComboEffect.SpriteEmitter7'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=202,R=174))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=206,R=140))
         ColorScale(3)=(RelativeTime=1.000000)
         MaxParticles=3
         StartSpinRange=(X=(Max=1.000000))
         SizeScale(0)=(RelativeSize=0.200000)
     ...
     End Object
     Emitters(4)=SpriteEmitter'CSHellHound.HoundComboEffect.SpriteEmitter6'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter8
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=128,R=200))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=200,R=190))
         ColorScale(3)=(RelativeTime=1.000000)
         MaxParticles=100
         DetailMode=DM_High
     ...
     End Object
     Emitters(5)=SpriteEmitter'CSHellHound.HoundComboEffect.SpriteEmitter8'
