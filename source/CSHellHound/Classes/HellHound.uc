class HellHound extends ONSWheeledcraft
      placeable;
...
#exec OBJ LOAD FILE=..\textures\Hounds_of_Hell.utx
...
static function StaticPrecache(LevelInfo L)
{
    ...
    L.AddPrecacheMaterial(Material'Hounds_of_Hell.HellHound.HellHoundRed');
    L.AddPrecacheMaterial(Material'Hounds_of_Hell.HellHound.HellHoundBlue');
...
simulated function UpdatePrecacheMaterials()
{
    ...
    Level.AddPrecacheMaterial(Material'Hounds_of_Hell.HellHound.HellHoundRed');
    Level.AddPrecacheMaterial(Material'Hounds_of_Hell.HellHound.HellHoundBlue');
...
//     TorqueCurve=(Points=((OutVal=9.000000),(InVal=200.000000,OutVal=10.000000),(InVal=1500.000000,OutVal=11.000000),(InVal=2500.000000)))
     ...
     DriverWeapons(0)=(WeaponClass=Class'CSHellHound.HellHoundDriverWeapon',WeaponBone="Dummy01")
     PassengerWeapons(0)=(WeaponPawnClass=Class'CSHellHound.HellHoundSideGunPawn',WeaponBone="Dummy01")
     PassengerWeapons(1)=(WeaponPawnClass=Class'CSHellHound.HellHoundRearGunPawn',WeaponBone="Dummy02")
     RedSkin=Texture'Hounds_of_Hell.HellHound.HellHoundRed'
     BlueSkin=Texture'Hounds_of_Hell.HellHound.HellHoundBlue'
     ...
     HeadlightCoronaMaterial=Texture'Hounds_of_Hell.HellHound.HellHoundFlare'
     HeadlightCoronaMaxSize=100.000000
     HeadlightProjectorMaterial=Texture'Hounds_of_Hell.HellHound.HellHoundProjector'
     ...
     End Object
     Wheels(0)=SVehicleWheel'CSHellHound.HellHound.SVehicleWheel4'
     ...
     End Object
     Wheels(1)=SVehicleWheel'CSHellHound.HellHound.SVehicleWheel5'
     ...
     End Object
     Wheels(2)=SVehicleWheel'CSHellHound.HellHound.SVehicleWheel6'
     ...
     End Object
     Wheels(3)=SVehicleWheel'CSHellHound.HellHound.SVehicleWheel7'
     ...
     End Object
     KParams=KarmaParamsRBFull'CSHellHound.HellHound.KarmaParamsRBFull1'
