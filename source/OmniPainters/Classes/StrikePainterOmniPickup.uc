class StrikePainterOmniPickup extends PainterPickup;
...
defaultproperties
{
     InventoryType=Class'OmniPainters.StrikePainterOmni'
     RespawnTime=60.000000
     PickupMessage="You got the Omni Nuclear Strike Painter."
