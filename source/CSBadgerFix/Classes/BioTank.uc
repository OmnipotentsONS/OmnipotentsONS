...
//Biotank.
//-----------------------------------------------------------
class BioTank extends ONSTreadCraft;

#exec OBJ LOAD FILE=..\Animations\ONSVehicles-A.ukx
#exec OBJ LOAD FILE=..\Sounds\ONSVehicleSounds-S.uax
#exec OBJ LOAD FILE=InterfaceContent.utx
#exec OBJ LOAD FILE=..\textures\VMVehicles-TX.utx
#exec OBJ LOAD FILE=..\textures\BioAegis_Tex.utx
#exec OBJ LOAD FILE=..\Sounds\BioAegis_Sound.uax
...
simulated function UpdatePrecacheMaterials()
{
    ...
    Level.AddPrecacheMaterial(Material'BioAegis_Tex.BioTank.BioTankBlue');
    Level.AddPrecacheMaterial(Material'BioAegis_Tex.BioTank.BioTankRed');
    Level.AddPrecacheMaterial(Material'BioAegis_Tex.BioTank.BioTankTread');
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'CSBadgerFix.BioTankCannon',WeaponBone="TankCannonWeapon")
     PassengerWeapons(0)=(WeaponPawnClass=Class'CSBadgerFix.BiotankSecondaryTurretPawn',WeaponBone="MachineGunTurret")
     RedSkin=Texture'BioAegis_Tex.BioTank.BioTankRed'
     BlueSkin=Texture'BioAegis_Tex.BioTank.BioTankBlue'
     ...
     VehiclePositionString="in a BioTank"
     VehicleNameString="BioTank"
     RanOverDamageType=Class'CSBadgerFix.BioDamTypeRoadkill'
     CrushedDamageType=Class'CSBadgerFix.BioDamTypePancake'
     MaxDesireability=0.800000
     FlagBone="MachineGunTurret"
     FlagRotation=(Yaw=32768)
     HornSounds(0)=Sound'BioAegis_Sound.BioTank.BioTankHorn1'
     HornSounds(1)=Sound'BioAegis_Sound.BioTank.BioTankHorn0'
     bCanStrafe=True
     GroundSpeed=800.000000
     HealthMax=1400.000000
     Health=1400
     Mesh=SkeletalMesh'ONSNewTank-A.HoverTank'
     Skins(1)=Texture'BioAegis_Tex.BioTank.BioTankTread'
     Skins(2)=Texture'BioAegis_Tex.BioTank.BioTankTread'
     SoundVolume=200
     ...
     Begin Object Class=KarmaParamsRBFull Name=KParams0
         ...
         KFriction=0.500000
     End Object
     KParams=KarmaParamsRBFull'CSBadgerFix.BioTank.KParams0'
