/**
WVFlameBadgerMAS.FlameBadgerNapalmGlob
...
class FlameBadgerNapalmGlob extends Projectile;
...
var FlameBadgerNapalmGlobFlames Trail;
...
simulated function PostNetBeginPlay()
{
	...
	{
		Trail = Spawn(class'FlameBadgerNapalmGlobFlames', Self);
	}
}
...
auto simulated state Flying
{
	simulated function Landed(vector HitNormal)
	{
		...
		Spawn(class'FlameBadgerNapalmScorch',,,, rotator(-HitNormal));
...
defaultproperties
{
     ...
     Damage=7.000000
     MyDamageType=Class'Badgers_V2beta3.DamTypeFlameBadgerNapalmGlob'
