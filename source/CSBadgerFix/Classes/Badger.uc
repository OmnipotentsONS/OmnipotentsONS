...
//
//-----------------------------------------------------------
class Badger extends ONSWheeledCraft;

//#exec OBJ LOAD FILE=..\Animations\Badger_Ani.ukx
#exec OBJ LOAD FILE=Animations\Badger_Ani_Fixed.ukx PACKAGE=CSBadgerFix
#exec OBJ LOAD FILE=..\Sounds\Badger_Sound.uax
#exec OBJ LOAD FILE=..\textures\EpicParticles.utx
#exec OBJ LOAD FILE=..\textures\Badger_Tex.utx
#exec OBJ LOAD FILE=..\StaticMeshes\Badger_SM.usx
...
static function StaticPrecache(LevelInfo L)
{
	...
	L.AddPrecacheStaticMesh(StaticMesh'Badger_SM.Wreck.BadgerWreck_Turret');
	L.AddPrecacheStaticMesh(StaticMesh'Badger_SM.Wreck.BadgerWreck_Minigun');
	L.AddPrecacheStaticMesh(StaticMesh'Badger_SM.Wreck.BadgerWreck_Wheel');
      L.AddPrecacheStaticMesh(StaticMesh'Badger_SM.Wreck.BadgerWreck_Hull');
    ...
    L.AddPrecacheMaterial(Material'Badger_Tex.BadgerRed');
    L.AddPrecacheMaterial(Material'Badger_Tex.BadgerBlue');
...
{
	Level.AddPrecacheStaticMesh(StaticMesh'Badger_SM.Wreck.BadgerWreck_Turret');
	Level.AddPrecacheStaticMesh(StaticMesh'Badger_SM.Wreck.BadgerWreck_Minigun');
	Level.AddPrecacheStaticMesh(StaticMesh'Badger_SM.Wreck.BadgerWreck_Wheel');
	Level.AddPrecacheStaticMesh(StaticMesh'Badger_SM.Wreck.BadgerWreck_Hull');
...
simulated function UpdatePrecacheMaterials()
{
    ...
    Level.AddPrecacheMaterial(Material'Badger_Tex.BadgerRed');
    Level.AddPrecacheMaterial(Material'Badger_Tex.BadgerBlue');
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'CSBadgerFix.BadgerMinigun',WeaponBone="MinigunSpawn")
     PassengerWeapons(0)=(WeaponPawnClass=Class'CSBadgerFix.BadgerTurretPawn',WeaponBone="TurretSpawn")
     RedSkin=Texture'Badger_Tex.Badger.BadgerRed'
     BlueSkin=Texture'Badger_Tex.Badger.BadgerBlue'
     IdleSound=Sound'Badger_Sound.BadgerEngine'
     StartUpSound=Sound'Badger_Sound.BadgerStart'
     ShutDownSound=Sound'Badger_Sound.BadgerStop'
     StartUpForce="PRVStartUp"
     ShutDownForce="PRVShutDown"
     DestroyedVehicleMesh=StaticMesh'Badger_SM.Wreck.BadgerWreck_Hull'
     DestructionEffectClass=Class'CSBadgerFix.BadgerDeath'
     DisintegrationEffectClass=Class'CSBadgerFix.ONSVehDeathBadger'
     ...
     End Object
     Wheels(0)=SVehicleWheel'CSBadgerFix.Badger.RRWheel'
     ...
     End Object
     Wheels(1)=SVehicleWheel'CSBadgerFix.Badger.LRWheel'
     ...
     End Object
     Wheels(2)=SVehicleWheel'CSBadgerFix.Badger.RFWheel'
     ...
     End Object
     Wheels(3)=SVehicleWheel'CSBadgerFix.Badger.LFWheel'
     ...
     VehiclePositionString="in a Badger"
     VehicleNameString="Badger )o("
     RanOverDamageType=Class'CSBadgerFix.BadgerRoadkill'
     CrushedDamageType=Class'CSBadgerFix.BadgerPancake'
     ObjectiveGetOutDist=1500.000000
     FlagBone="MinigunSpawn"
     FlagRotation=(Yaw=32768)
     HornSounds(0)=Sound'Badger_Sound.BadgerHorn'
     HornSounds(1)=Sound'Badger_Sound.BadgerHorn'
     ...
     End Object
     KParams=KarmaParamsRBFull'CSBadgerFix.Badger.KParams0'
