class BioSecondaryTurret extends ONSWeapon;

#exec OBJ LOAD FILE=..\Animations\ONSWeapons-A.ukx
#exec OBJ LOAD FILE=..\Textures\TurretParticles.utx

var class<BioBeamEffect> BeamEffectClass[2];
...
defaultproperties
{
     BeamEffectClass(0)=Class'CSBadgerFix.BioBeamEffectBlue'
     BeamEffectClass(1)=Class'CSBadgerFix.BioBeamEffectBlue'
     YawBone="Object01"
     PitchBone="Object02"
     PitchUpLimit=14500
     ...
     FireSoundClass=Sound'CuddlyArmor_Sound.BioTank.BioBeam'
     FireForce="Laser01"
     DamageType=Class'CSBadgerFix.BioBeam'
     DamageMin=30
     DamageMax=30
     TraceRange=18000.000000
