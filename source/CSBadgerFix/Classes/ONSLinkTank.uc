...
class ONSLinkTank extends ONSHoverTank;
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'CSBadgerFix.ONSLinkTankWeapon')
     PassengerWeapons(0)=(WeaponPawnClass=Class'CSBadgerFix.ONSLinkTankTertiaryTurretPawn',WeaponBone="SecondaryTurretAttach")
     bHasAltFire=True
     ...
     RanOverDamageType=Class'CSBadgerFix.DamTypeLinkTankRoadkill'
     CrushedDamageType=Class'CSBadgerFix.DamTypeLinkTankPancake'
