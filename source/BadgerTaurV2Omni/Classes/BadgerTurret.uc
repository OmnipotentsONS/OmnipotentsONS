class BadgerTurret extends ONSWeapon;
...
defaultproperties
{
     ...
     RotationsPerSecond=0.900000
     Spread=0.005000
     RedSkin=Texture'Badger_Tex.Badger.BadgerRed'
     BlueSkin=Texture'Badger_Tex.Badger.BadgerBlue'
     FireInterval=2.000000
     EffectEmitterClass=Class'CSBadgerFix.ONSBadgerFireEffect'
     FireSoundClass=Sound'Badger_Sound.BadgerCannon'
     FireSoundVolume=535.000000
     FireForce="Explosion05"
     ProjectileClass=Class'CSBadgerFix.BadgerProjectile'
     ...
     Mesh=SkeletalMesh'Badger_Ani.BadgerTurret'
     bSelected=True
}
