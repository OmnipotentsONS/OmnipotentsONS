class VehDeathHeavyTank extends Emitter;
...
defaultproperties
{
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter43
         ...
         StartSizeRange=(X=(Min=1.100000),Y=(Min=1.100000),Z=(Min=1.100000))
         InitialParticlesPerSecond=5000.000000
         LifetimeRange=(Min=1.500000,Max=2.000000)
         StartVelocityRange=(X=(Min=-200.000000,Max=200.000000),Y=(Min=-200.000000,Max=200.000000),Z=(Min=1000.000000,Max=1400.000000))
     End Object
     Emitters(5)=MeshEmitter'HeavyTankV2Omni.VehDeathHeavyTank.MeshEmitter43'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitterTur
         StaticMesh=StaticMesh'ONSBP_DestroyedVehicles.SPMA.SPMA_Turretpiece'
         UseParticleColor=True
         UseColorScale=True
         RespawnDeadParticles=False
         SpinParticles=True
         ...
         UseRotationFrom=PTRS_Actor
         SpinsPerSecondRange=(X=(Min=1.000000,Max=1.000000),Y=(Max=0.200000))
         StartSizeRange=(X=(Min=1.800000,Max=1.800000))
         InitialParticlesPerSecond=5000.000000
         DrawStyle=PTDS_AlphaBlend
         LifetimeRange=(Min=1.500000,Max=2.500000)
         StartVelocityRange=(X=(Min=-200.000000,Max=200.000000),Y=(Min=-200.000000,Max=200.000000),Z=(Min=1200.000000,Max=1800.000000))
     End Object
     Emitters(15)=MeshEmitter'HeavyTankV2Omni.VehDeathHeavyTank.MeshEmitterTur'
