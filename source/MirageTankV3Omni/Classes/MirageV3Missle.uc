class MirageV3Missle extends Projectile;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    {
    	Spawn(class'MirageMissileExplosion',,,HitLocation + HitNormal*16,rotator(HitNormal));
...
defaultproperties
{
     TrailClass=Class'MirageTankV3Omni.MirageMissileSmokeTrail'
     ...
     MyDamageType=Class'MirageTankV3Omni.DamTypeMirageMissle'
