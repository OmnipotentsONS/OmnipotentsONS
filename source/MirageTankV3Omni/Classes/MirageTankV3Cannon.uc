...
//
//-----------------------------------------------------------
class MirageTankV3Cannon extends ONSWeapon;
...
defaultproperties
{
     ...
     Spread=0.015000
     RedSkin=Texture'MirageTankII.MirageTurretRed'
     BlueSkin=Texture'MirageTankII.MirageTurretBlue'
     FireInterval=2.500000
     EffectEmitterClass=Class'Onslaught.ONSTankFireEffect'
     FireSoundClass=Sound'VMVehicleSounds-S.HoverTank.TankFire'
     FireSoundVolume=512.000000
     FireForce="Explosion05"
     ProjectileClass=Class'MirageTankV3Omni.MirageTankV3RocketProjectile'
