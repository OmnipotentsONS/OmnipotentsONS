class MirageTankV3PlasmaPawn extends ONSWeaponPawn;


defaultproperties
{
     GunClass=Class'MirageTankV3Omni.MirageTankV3PlasmaGun'
     CameraBone="Object83"
     ...
     VehiclePositionString="in a Mirage Panzer Plasma Gun Turret"
     VehicleNameString="Mirage Panzer Plasma Gun Turret"
     AmbientGlow=12
     bShadowCast=True
