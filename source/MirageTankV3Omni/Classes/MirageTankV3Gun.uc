...
//
//-----------------------------------------------------------
class MirageTankV3Gun extends ONSWeapon;
...
defaultproperties
{
     TeamProjectileClasses(0)=Class'MirageTankV3Omni.MirageTankV3RedProjectile'
     TeamProjectileClasses(1)=Class'MirageTankV3Omni.MirageTankV3GunProjectile'
     MinAim=0.900000
     YawBone="rvGUNTurret"
     PitchBone="rvGUNbody"
     PitchUpLimit=18000
     ...
     ProjectileClass=Class'MirageTankV3Omni.MirageTankV3RedProjectile'
