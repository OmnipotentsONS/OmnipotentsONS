/**
WVDraco.DracoNapalmGlob

Creation date: 2013-11-11 09:43
Last change: $Id$
Copyright (c) 2013, Wormbo
*/

class DracoNapalmGlob extends Projectile;
...
simulated function PostNetBeginPlay()
{
	...
	{
		Trail = Spawn(class'DracoNapalmFlames', Self);
	}
}
...
defaultproperties
{
     ...
     Damage=7.000000
     MyDamageType=Class'FireVehiclesV2Omni.DamTypeDracoNapalmGlob'
