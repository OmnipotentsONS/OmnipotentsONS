class FireHoundSideGunPawn extends ONSWeaponPawn;
...
defaultproperties
{
     GunClass=Class'FireVehiclesV2Omni.FireHoundSideGun'
     ...
     VehiclePositionString="in a Fire Hound's side turret"
     VehicleNameString="Fire Hound Side Turret"
}
