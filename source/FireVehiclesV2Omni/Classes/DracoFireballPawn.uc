...
class DracoFireballPawn extends ONSWeaponPawn CacheExempt;
...
defaultproperties
{
     GunClass=Class'FireVehiclesV2Omni.DracoFireballSmallPack'
     ...
     VehicleNameString="Draco Fireball Rocket Turret"
}
