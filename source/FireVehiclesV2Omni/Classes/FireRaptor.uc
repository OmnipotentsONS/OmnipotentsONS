//-----------------------------------------------------------
// Ifrit Fire Raptor by ~Ca5ti3l~ (c) 2016.
//-----------------------------------------------------------
class FireRaptor extends ONSChopperCraft
    placeable;

#exec OBJ LOAD FILE=..\textures\VMVehicles-TX.utx
#exec OBJ LOAD FILE=..\textures\Ifrit.utx
...
if (DamageType.name == 'DamTypeFlakChunk')
		Damage *= 1.20;
...
//added HUD 10/01/21 pooty
	L.AddPrecacheMaterial(texture'AssaultHUD');
...
defaultproperties
{
     ...
     MaxThrustForce=155.000000
     LongDamping=0.050000
     MaxStrafeForce=100.000000
     LatDamping=0.050000
     MaxRiseForce=85.000000
     UpDamping=0.050000
     ...
     DriverWeapons(0)=(WeaponClass=Class'FireVehiclesV2Omni.FireRaptorGun',WeaponBone="PlasmaGunAttachment")
     RedSkin=Texture'Ifrit.ChargerTextures.IfritREDeyes1'
     BlueSkin=Texture'Ifrit.ChargerTextures.IfritBLUEeyes1'
    ...
    // HornSounds(0)=Sound'ONSVehicleSounds-S.Horns.Horn03'
     ...
     End Object
     KParams=KarmaParamsRBFull'FireVehiclesV2Omni.FireRaptor.KParams0'
