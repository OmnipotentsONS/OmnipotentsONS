...
//
//-----------------------------------------------------------
class HospitalerRearGun extends ONSWeapon;
...
defaultproperties
{
     ...
     bDoOffsetTrace=True
     RedSkin=Texture'IllyTemplar_and_HospitalerSkins.both.Hospi_Templar_Turrets'
     BlueSkin=Texture'IllyTemplar_and_HospitalerSkins.both.Hospi_Templar_Turrets'
