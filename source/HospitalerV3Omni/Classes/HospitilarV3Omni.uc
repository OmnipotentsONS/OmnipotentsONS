...
//
//-----------------------------------------------------------
class HospitilarV3Omni extends ONSWheeledCraft
placeable;
...
event TakeDamage(int Damage, Pawn EventInstigator, vector HitLocation, vector Momentum, class<DamageType> DamageType)
{
	...
	if ( (WeaponPawns.Length > 0) && HospitilarShieldCannon(WeaponPawns[0].Gun).bShieldActive && (HospitilarShieldCannon(WeaponPawns[0].Gun).ShockShield != None) && (Momentum != vect(0,0,0))
		...
		&& !HospitilarShieldCannon(WeaponPawns[0].Gun).ShockShield.TraceThisActor(ShieldHitLocation,ShieldHitNormal,HitLocation,HitLocation - 2000*Normal(Momentum)) )
		return;

	// don't take damage if should have been blocked by shield
	if ( (WeaponPawns.Length > 1) && HospitilarShieldCannon(WeaponPawns[1].Gun).bShieldActive && (HospitilarShieldCannon(WeaponPawns[1].Gun).ShockShield != None) && (Momentum != vect(0,0,0))
		&& (HitLocation != Location) && (DamageType != None) && (ClassIsChildOf(DamageType,class'WeaponDamageType') || ClassIsChildOf(DamageType,class'VehicleDamageType')) 
		&& !HospitilarShieldCannon(WeaponPawns[1].Gun).ShockShield.TraceThisActor(ShieldHitLocation,ShieldHitNormal,HitLocation,HitLocation - 2000*Normal(Momentum)) )
		return;

	// don't take damage if should have been blocked by shield
	if ( (WeaponPawns.Length > 2) && HospitilarShieldCannon(WeaponPawns[0].Gun).bShieldActive && (HospitilarShieldCannon(WeaponPawns[2].Gun).ShockShield != None) && (Momentum != vect(0,0,0))
		&& (HitLocation != Location) && (DamageType != None) && (ClassIsChildOf(DamageType,class'WeaponDamageType') || ClassIsChildOf(DamageType,class'VehicleDamageType')) 
		&& !HospitilarShieldCannon(WeaponPawns[2].Gun).ShockShield.TraceThisActor(ShieldHitLocation,ShieldHitNormal,HitLocation,HitLocation - 2000*Normal(Momentum)) )
		return;

	// don't take damage if should have been blocked by shield
	if ( (WeaponPawns.Length > 3) && HospitilarShieldCannon(WeaponPawns[3].Gun).bShieldActive && (HospitilarShieldCannon(WeaponPawns[3].Gun).ShockShield != None) && (Momentum != vect(0,0,0))
		&& (HitLocation != Location) && (DamageType != None) && (ClassIsChildOf(DamageType,class'WeaponDamageType') || ClassIsChildOf(DamageType,class'VehicleDamageType')) 
		&& !HospitilarShieldCannon(WeaponPawns[3].Gun).ShockShield.TraceThisActor(ShieldHitLocation,ShieldHitNormal,HitLocation,HitLocation - 2000*Normal(Momentum)) )
		return;
...
defaultproperties
{
     ...
     TorqueCurve=(Points=((OutVal=12.000000),(InVal=200.000000,OutVal=2.000000),(InVal=2500.000000,OutVal=1.500000),(InVal=3500.000000)))
     ...
     DriverWeapons(0)=(WeaponClass=Class'HospitalerV3Omni.HospitilarRocketPack',WeaponBone="RocketPackAttach")
     DriverWeapons(1)=(WeaponClass=Class'HospitalerV3Omni.HospitilarCannon',WeaponBone="maingunpostBase")
     PassengerWeapons(0)=(WeaponPawnClass=Class'HospitalerV3Omni.HospitilarShieldCannonPawn',WeaponBone="RightFrontgunAttach")
     PassengerWeapons(1)=(WeaponPawnClass=Class'HospitalerV3Omni.HospitilarShieldCannonPawn',WeaponBone="LeftFrontGunAttach")
     PassengerWeapons(2)=(WeaponPawnClass=Class'HospitalerV3Omni.HospitilarShieldCannonPawn',WeaponBone="RightRearGunAttach")
     PassengerWeapons(3)=(WeaponPawnClass=Class'HospitalerV3Omni.HospitilarShieldCannonPawn',WeaponBone="LeftRearGunAttach")
     PassengerWeapons(4)=(WeaponPawnClass=Class'HospitalerV3Omni.HospitilarLinkGunPawn',WeaponBone="RightFrontgunAttach")
     PassengerWeapons(5)=(WeaponPawnClass=Class'HospitalerV3Omni.HospitilarLinkGunPawn',WeaponBone="LeftFrontGunAttach")
     PassengerWeapons(6)=(WeaponPawnClass=Class'HospitalerV3Omni.HospitilarRearGunPawn',WeaponBone="RightRearGunAttach")
     PassengerWeapons(7)=(WeaponPawnClass=Class'HospitalerV3Omni.HospitilarRearGunPawn',WeaponBone="LeftRearGunAttach")
     bHasAltFire=False
     ...
     End Object
     KParams=KarmaParamsRBFull'HospitalerV3Omni.HospitilarV3Omni.KParams0'
