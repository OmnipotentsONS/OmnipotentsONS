...
class KBDamTypeMercurySplashDamage extends VehicleDamageType abstract;
...
defaultproperties
{
     ...
     FemaleSuicide="%o checked if her Viper's rocket launchers were loaded."
     MaleSuicide="%o checked if his Viper's rocket launchers were loaded."
     bDetonatesGoop=True
