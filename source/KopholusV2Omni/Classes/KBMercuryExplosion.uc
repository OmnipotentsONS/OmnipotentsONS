...
class KBMercuryExplosion extends Emitter notplaceable;
...
simulated event PostNetBeginPlay()
{
	...
	if (!PC.BeyondViewDistance(Location, class'KBMercuryExplosionLight'.default.CullDistance)) {
		Spawn(class'KBMercuryExplosionLight');
	}
