...
//-----------------------------------------------------------
class SkaarjViperFrontGun extends ONSWeapon;

#exec OBJ LOAD FILE=..\Animations\ONSWeapons-A.ukx

var class<ShockBeamEffect> BeamEffectClass;
var HellHoundSkyMine ComboTarget;
var float MinAim;
...
function SetComboTarget(HellHoundSkyMine S)
{
...
state InstantFireMode
{
    ...
    {
    	local HellHoundSkyMine S;

    	S = HellHoundSkyMine(SpawnProjectile(ProjectileClass, False));
...
//     ProjectileClass=Class'KopholusV2Omni.ViperFrontProjectile'
...
//     GunnerAttachmentBone="SideGunnerLocation"
     ...
     FlashEmitterClass=Class'CSHellHound.HoundMuzzleFlash'
