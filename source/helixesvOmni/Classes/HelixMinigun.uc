class HelixMinigun extends ONSWeapon;
...
defaultproperties
{
     ...
     YawBone="MinigunPitch"
     PitchBone="MinigunPitch"
     PitchUpLimit=69500
     PitchDownLimit=42000
     WeaponFireAttachmentBone="Fire"
     GunnerAttachmentBone="playerview"
     DualFireOffset=9.000000
     RotationsPerSecond=5.000000
     ...
     FireForce="minifireb"
     DamageType=Class'helixesvOmni.DamTypeHelix'
     DamageMin=23
     DamageMax=25
     ...
     Mesh=SkeletalMesh'Helix2_final.Minigun'
}
