...
//
//-----------------------------------------------------------
class CSBomberWeaponBeamEffect extends ONSTurretBeamEffect;
...
simulated function PostNetBeginPlay()
{
	...
	//PlaySound(Sound'CicadaSnds.BellyLaser.BellyLaserFire', SLOT_None, 1.0,, 300,1.3, false);
	PlaySound(Sound'WeaponSounds.AssaultRifle.AssaultRifleFire', SLOT_None, 1.0,, 300,pitch, false);
}
