class CSBioBomberWeaponBeamEffect extends Emitter;
...
defaultproperties
{
    NetPriority=3.0
     Begin Object Class=BeamEmitter Name=BeamEmitter0
         ...
         ColorScale(0)=(Color=(B=32,G=192,R=32))
     ...
     End Object
     Emitters(0)=BeamEmitter'CSBomber.CSBioBomberWeaponBeamEffect.BeamEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         StartVelocityRange=(X=(Min=500.000000,Max=500.000000))
     End Object
     Emitters(1)=BeamEmitter'CSBomber.CSBioBomberWeaponBeamEffect.BeamEmitter1'
     ...
     End Object
     Emitters(2)=SpriteEmitter'CSBomber.CSBioBomberWeaponBeamEffect.SpriteEmitter17'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter19
         ...
         ColorScale(0)=(Color=(B=128,G=128,R=255))
         ColorScale(1)=(RelativeTime=0.650000,Color=(B=23,G=132,R=23))
         ColorScale(2)=(RelativeTime=1.000000)
         MaxParticles=8
     ...
     End Object
     Emitters(3)=SpriteEmitter'CSBomber.CSBioBomberWeaponBeamEffect.SpriteEmitter19'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter20
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=32,G=255,R=32))
         ...
         LifetimeRange=(Min=0.200000,Max=0.200000)
     End Object
     Emitters(4)=SpriteEmitter'CSBomber.CSBioBomberWeaponBeamEffect.SpriteEmitter20'
