class CSSpankBomberBeamEffect extends ShockBeamEffect;

simulated function SpawnImpactEffects(rotator HitRot, vector EffectLoc)
{
    Spawn(class'CSBomber.CSSpankBomberProjectileExplosion',,,EffectLoc,HitRot);
}
...
defaultproperties
{
	...
	CoilClass=class'CSSpankBomberShockBeamCoil'
	MuzFlashClass=class'CSSpankBomberMuzzleFlash'
	MuzFlash3Class=class'CSSpankBomberMuzzleFlash'
    //Texture=Texture'ShockBeamTex'
    //Skins(0)=Texture'ShockBeamTex'

    Texture=Texture'CSBomber.ShockBeamTex'
    Skins(0)=Texture'CSBomber.ShockBeamTex'
