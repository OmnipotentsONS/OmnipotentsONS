class CSSpankBomberProjectile extends Projectile;

#exec AUDIO IMPORT FILE=Sounds\smallpop.wav

var int PawnMomentumTransfer;
var CSSpankBomberProjectileEffect ONSShockBallEffect;
...
simulated function PostBeginPlay()
{
	...
	{
        ONSShockBallEffect = Spawn(class'CSSpankBomberProjectileEffect', self);
...
simulated function SuperExplosion()
{
	...
	Spawn(class'CSSpankBomberProjectileExplosion');
...
defaultproperties
{
    ...
    TossZ=0.0
	DamageRadius=280.0
    ComboSound=sound'CSBomber.smallpop'
    ...
    Skins(0)=None
    Texture=None
    MyDamageType=Class'CSBomber.CSSpankBomberDamTypeProjectile'
    AmbientGlow=255
