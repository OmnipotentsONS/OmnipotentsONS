class CSBioBomberWeaponBeamEffectBlue extends CSBioBomberWeaponBeamEffect;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter4
         ...
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=100,G=255,R=100,A=128))
     ...
     End Object
     Emitters(0)=BeamEmitter'CSBomber.CSBioBomberWeaponBeamEffectBlue.BeamEmitter4'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter5
         ...
         StartVelocityRange=(X=(Min=500.000000,Max=500.000000))
     End Object
     Emitters(1)=BeamEmitter'CSBomber.CSBioBomberWeaponBeamEffectBlue.BeamEmitter5'
     ...
     End Object
     Emitters(2)=SpriteEmitter'CSBomber.CSBioBomberWeaponBeamEffectBlue.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         ColorScale(1)=(RelativeTime=0.200000,Color=(B=55,G=199,R=55))
         ColorScale(2)=(RelativeTime=0.650000,Color=(B=23,G=160,R=23))
     ...
     End Object
     Emitters(3)=SpriteEmitter'CSBomber.CSBioBomberWeaponBeamEffectBlue.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         BlendBetweenSubdivisions=True
         UseRandomSubdivision=True
         ColorScale(0)=(Color=(B=90,G=255,R=90))
         ...
         LifetimeRange=(Min=0.200000,Max=0.200000)
     End Object
     Emitters(4)=SpriteEmitter'CSBomber.CSBioBomberWeaponBeamEffectBlue.SpriteEmitter2'
