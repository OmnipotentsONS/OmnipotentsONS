...
//
//-----------------------------------------------------------
class WaspFlakGun extends ONSAttackCraftGun;
...
{
     ProjPerFire=5
     AltFireProjPerFire=9
     ProjSpread=600
     AltFireProjSpread=1500
     ...
     ProjectileClass=Class'Wasp_SeriesII.WaspFlakChunk'
     AltFireProjectileClass=Class'Wasp_SeriesII.WaspFlakChunk'
