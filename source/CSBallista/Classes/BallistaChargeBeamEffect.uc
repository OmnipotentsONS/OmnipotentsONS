class BallistaChargeBeamEffect extends Emitter;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter0
         ...
         ColorScale(0)=(Color=(B=255,G=68,R=78))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=128,G=50,R=255))
     ...
     End Object
     Emitters(0)=BeamEmitter'CSBallista.BallistaChargeBeamEffect.BeamEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=64,G=70,R=255))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=255,G=50,R=128))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.400000
         MaxParticles=1
         StartLocationOffset=(Y=-6.000000)
     ...
     End Object
     Emitters(1)=BeamEmitter'CSBallista.BallistaChargeBeamEffect.BeamEmitter1'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter2
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=192,R=100))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=205,G=7,R=70))
         ColorScale(2)=(RelativeTime=1.000000)
         MaxParticles=1
         StartLocationOffset=(Y=6.000000)
         UseRotationFrom=PTRS_Actor
         ...
         LifetimeRange=(Min=0.450000,Max=0.450000)
     End Object
     Emitters(2)=BeamEmitter'CSBallista.BallistaChargeBeamEffect.BeamEmitter2'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter3
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=64,G=62,R=255))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=255,G=10,R=140))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.400000
         MaxParticles=1
         StartLocationOffset=(Y=6.000000)
         ...
         LifetimeRange=(Min=0.600000,Max=0.600000)
     End Object
     Emitters(3)=BeamEmitter'CSBallista.BallistaChargeBeamEffect.BeamEmitter3'
