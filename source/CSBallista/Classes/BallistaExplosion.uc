class BallistaExplosion extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=15,G=181,R=225))
     ...
     End Object
     Emitters(0)=SpriteEmitter'CSBallista.BallistaExplosion.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000)
         ColorScale(2)=(RelativeTime=0.660000,Color=(G=178,R=215,A=190))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=60
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(1)=SpriteEmitter'CSBallista.BallistaExplosion.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         AutomaticInitialSpawning=False
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000,Color=(B=60,G=90,R=110,A=100))
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=80,G=140,R=120,A=255))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=150
         StartLocationShape=PTLS_Sphere
     ...
     End Object
     Emitters(2)=SpriteEmitter'CSBallista.BallistaExplosion.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000)
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=15,G=171,R=225))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=50
         StartLocationShape=PTLS_Sphere
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(3)=SpriteEmitter'CSBallista.BallistaExplosion.SpriteEmitter3'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter0
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=56,G=187,R=197))
         ColorScale(2)=(RelativeTime=0.600000,Color=(B=7,G=197,R=216))
         ColorScale(3)=(RelativeTime=1.000000)
     ...
     End Object
     Emitters(4)=MeshEmitter'CSBallista.BallistaExplosion.MeshEmitter0'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter1
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=215,G=235,R=255,A=255))
         ColorScale(2)=(RelativeTime=0.600000,Color=(B=195,G=225,R=255,A=128))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeOutStartTime=1.000000
         FadeInEndTime=0.100000
         MaxParticles=1
     ...
     End Object
     Emitters(5)=MeshEmitter'CSBallista.BallistaExplosion.MeshEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(1)=(RelativeTime=0.600000,Color=(B=64,G=196,R=235))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=23,G=141,R=210))
         ColorScale(3)=(RelativeTime=1.000000)
         MaxParticles=2
         SizeScale(0)=(RelativeSize=0.200000)
     ...
     End Object
     Emitters(6)=SpriteEmitter'CSBallista.BallistaExplosion.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=55,G=162,R=214))
         ...
         LifetimeRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(7)=SpriteEmitter'CSBallista.BallistaExplosion.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(G=92,R=173))
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(8)=SpriteEmitter'CSBallista.BallistaExplosion.SpriteEmitter6'
     ...
     End Object
     Emitters(9)=MeshEmitter'CSBallista.BallistaExplosion.MeshEmitter2'
