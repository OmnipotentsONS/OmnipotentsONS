class BallistaChargeGun extends ONSWeapon;

#exec OBJ LOAD FILE=..\Animations\ONSWeapons-A.ukx

var class<BallistaChargeBeamEffect> BeamEffectClass;
...
{
	local BallistaChargeBeamEffect Beam;
...
defaultproperties
{
     BeamEffectClass=Class'CSBallista.BallistaChargeBeamEffect'
     ...
     FlashEmitterClass=Class'CSBallista.BallistaGunCharge'
