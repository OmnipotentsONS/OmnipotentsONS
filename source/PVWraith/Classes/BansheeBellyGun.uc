...
class BansheeBellyGun extends ONSDualACGatlingGun;


#exec audio import file=Sounds\BansheeLinkAmbient.wav
...
var class<BansheeLinkBeamEffect> BeamEffectClass;
var array<class<Projectile> > TeamProjectileClasses;

var BansheeLinkBeamEffect Beam1, Beam2;
...
defaultproperties
{
     ...
     SelfHealMultiplier=0.400000
     LinkBreakError=0.950000
     BeamEffectClass=Class'PVWraith.BansheeLinkBeamEffect'
     TeamProjectileClasses(0)=Class'PVWraith.BansheeLinkPlasmaProjectileRed'
     TeamProjectileClasses(1)=Class'PVWraith.BansheeLinkPlasmaProjectileBlue'
     ...
     AltFireSoundClass=Sound'PVWraith.BansheeLinkAmbient'
     DamageType=Class'PVWraith.DamTypeBansheeLinkBeam'
     DamageMin=15
     DamageMax=15
     TraceRange=4000.000000
     Momentum=-100000.000000
     ProjectileClass=Class'PVWraith.BansheeLinkPlasmaProjectile'
