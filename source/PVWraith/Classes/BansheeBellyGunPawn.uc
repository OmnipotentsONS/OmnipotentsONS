...
class BansheeBellyGunPawn extends ONSDualACGatlingGunPawn CacheExempt;
...
defaultproperties
{
     GunClass=Class'PVWraith.BansheeBellyGun'
     FPCamPos=(X=0.000000)
     VehiclePositionString="in a Banshee turret"
     VehicleNameString="Banshee Turret"
}
