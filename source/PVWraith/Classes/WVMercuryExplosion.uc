...
class WVMercuryExplosion extends Emitter notplaceable;
...
simulated event PostNetBeginPlay()
{
	...
	if (!PC.BeyondViewDistance(Location, class'WVMercuryExplosionLight'.default.CullDistance)) {
		Spawn(class'WVMercuryExplosionLight');
	}
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'PVWraith.WVMercuryExplosion.ExplosionRing'
     ...
     Begin Object Class=SpriteEmitter Name=ExplosionSmokeRing
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(1)=SpriteEmitter'PVWraith.WVMercuryExplosion.ExplosionSmokeRing'
