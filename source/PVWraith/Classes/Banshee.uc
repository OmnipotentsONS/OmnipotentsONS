...
class Banshee extends ONSDualAttackCraft;


//#exec obj load WVMercuryMissiles.u package=WVBanshee
#exec audio import File=Sounds\BansheeEngine.wav
#exec audio import File=Sounds\BansheeStart.wav
#exec audio import File=Sounds\BansheeStop.wav
...
simulated function DrawHUD(Canvas C)
{
	...
	HudMissileDigits.Value = BansheeSideGun(Weapons[0]).RemainingShotCount;
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'PVWraith.BansheeSideGun')
     DriverWeapons(1)=(WeaponClass=Class'PVWraith.BansheeSideGun')
     PassengerWeapons(0)=(WeaponPawnClass=Class'PVWraith.BansheeBellyGunPawn')
     bHasAltFire=False
     IdleSound=Sound'PVWraith.WraithEngine'
     StartUpSound=Sound'PVWraith.BansheeStart'
     ShutDownSound=Sound'PVWraith.BansheeStop'
     VehiclePositionString="in a Banshee"
     VehicleNameString="Banshee"
     VehicleDescription="In legend, a banshee is a fairy woman who begins to wail if someone is about to die. The tricky part is: The one who will die cannot hear her."
     RanOverDamageType=Class'PVWraith.DamTypeBansheeRoadkill'
     CrushedDamageType=Class'PVWraith.DamTypeBansheePancake'
}
