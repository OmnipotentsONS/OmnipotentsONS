...
//
//-----------------------------------------------------------
class NodeRunOmniRearTwinBeamPawn extends ONSWeaponPawn;
...
defaultproperties
{
     GunClass=Class'NodeRunnerOmni.NodeRunOmniRearGunTwinBeam'
     bHasAltFire=False
     CameraBone="Dummy02"
     ...
     VehiclePositionString="in a NodeRunner's TwinBeam turret"
     VehicleNameString="NodeRunner Omni TwinBeam Turret"
}
