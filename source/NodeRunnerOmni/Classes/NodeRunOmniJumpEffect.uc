...
//
//-----------------------------------------------------------
class NodeRunOmniJumpEffect extends Emitter;
...
defaultproperties
{
	    ...
	    Begin Object Class=MeshEmitter Name=MeshEmitter14
         ...
         StartLocationOffset=(X=-52.000000,Y=0.000000,Z=-20.000000)
         SpinsPerSecondRange=(X=(Min=0.750000,Max=1.000000))
         StartSpinRange=(X=(Max=1.000000))
         SizeScale(0)=(RelativeSize=1.500000)
         SizeScale(1)=(RelativeTime=1.500000,RelativeSize=2.25000)
     ...
     End Object
     Emitters(0)=MeshEmitter'NodeRunnerOmni.NodeRunOmniJumpEffect.MeshEmitter14'
   ...
   /*  Begin Object Class=MeshEmitter Name=MeshEmitter14
         ...
         MaxParticles=2
         //StartLocationOffset=(X=21.000000,Y=75.000000,Z=-20.000000)
         StartLocationOffset=(X=-10.000000,Y=80.000000,Z=-20.000000)
         SpinsPerSecondRange=(X=(Min=0.750000,Max=1.000000))
         StartSpinRange=(X=(Max=1.000000))
         SizeScale(0)=(RelativeSize=1.000000)
         SizeScale(1)=(RelativeTime=1.000000,RelativeSize=1.50000)
         StartSizeRange=(X=(Min=0.800000),Y=(Min=0.800000),Z=(Min=0.500000,Max=1.500000))
         InitialParticlesPerSecond=50.000000
         DrawStyle=PTDS_Brighten
         LifetimeRange=(Min=0.500000,Max=0.750000)
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter15
         ...
         LifetimeRange=(Min=0.500000,Max=0.750000)
     End Object
     Emitters(1)=MeshEmitter'NodeRunnerOmni.NodeRunOmniJumpEffect.MeshEmitter15'
*/
     AutoDestroy=True
