...
//
//-----------------------------------------------------------
class NodeRunOmniRearGunTwinBeam extends ONSWeapon;
...
defaultproperties
{
     ...
     bDoOffsetTrace=True
     RedSkin=Texture'NodeRunnerOmniTex.NRturretTwinBeamRed'
     BlueSkin=Texture'NodeRunnerOmniTex.NRturretTwinBeamBlue'
     FireInterval=0.000000
     FlashEmitterClass=Class'NodeRunnerOmni.NodeRunOmniRearGunCharge'
    ...
    // Skins(0)=Texture'NodeRunnerOmniTex.NRturretTwinBeam'
     DrawScale=0.800000
}
