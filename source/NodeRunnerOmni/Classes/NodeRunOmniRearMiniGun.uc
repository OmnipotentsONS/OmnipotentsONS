class NodeRunOmniRearMiniGun extends ONSWeapon;

#exec OBJ LOAD FILE=..\textures\NodeRunnerTex.utx
...
defaultproperties
{
     ...
     bIsRepeatingFF=True
     Spread=0.010000
    // RedSkin=Texture'NodeRunnerTex.NRturret'
    // BlueSkin=Texture'NodeRunnerTex.NRturret'
     FireInterval=0.10000
     AmbientEffectEmitterClass=Class'Onslaught.ONSRVChainGunFireEffect'
     FireSoundClass=Sound'WeaponSounds.Minigun.minialtfireb'
     ...
     Mesh=SkeletalMesh'ONSNodeRunner.NRturret'
     Skins(0)=Texture'NodeRunnerOmniTex.NRturretMiniGun'
     DrawScale=0.800000
}
