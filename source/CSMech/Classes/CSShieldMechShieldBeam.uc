class CSShieldMechShieldBeam extends ShockBeamEffect;
...
{
    local CSShieldMechForceRing A;
	A = Spawn(class'CSShieldMechForceRing',,, EffectLoc, HitRot);
    if(A != None)
    {
...
defaultproperties
{
	...
	CoilClass=class'CSShieldMechShieldCoil'
