...
//
//-----------------------------------------------------------
class MirageRaptorOmni extends ONSChopperCraft
    placeable;
    /*
#exec OBJ LOAD FILE=forcompile\Mraptor.ukx Package=MirageRaptorOmni
#exec OBJ LOAD FILE=forcompile\MRaptorSounds.uax Package=MirageRaptorOmni
#exec OBJ LOAD FILE=forcompile\RaptorSkins.utx Package=MirageRaptorOmni
*/
#exec OBJ LOAD FILE=MirageRaptorSounds.uax


var()   float							MaxPitchSpeed;

var()   array<vector>					TrailEffectPositions;
var     class<MirageRaptorOmniExhaust>	TrailEffectClass;
var     array<MirageRaptorOmniExhaust>	TrailEffects;
...
defaultproperties
{
     ...
     TrailEffectPositions(2)=(X=-16.000000,Y=-48.500000,Z=-18.000000)
     TrailEffectPositions(3)=(X=-16.000000,Y=48.500000,Z=-18.000000)
     TrailEffectClass=Class'MirageRaptorOmni.MirageRaptorOmniExhaust'
     StreamerEffectOffset(0)=(X=-148.000000,Y=-26.000000,Z=51.000000)
     StreamerEffectOffset(1)=(X=-148.000000,Y=26.000000,Z=51.000000)
     StreamerEffectOffset(2)=(X=-16.000000,Y=-48.500000,Z=-18.000000)
     StreamerEffectOffset(3)=(X=-16.000000,Y=48.500000,Z=-18.000000)
     ...
     DriverWeapons(0)=(WeaponClass=Class'MirageRaptorOmni.MirageRaptorOmniGun',WeaponBone="GUN1")
     RedSkin=Texture'MirageRaptor_Tex.RaptorRed'
     BlueSkin=Texture'MirageRaptor_Tex.RaptorBlue'
     IdleSound=Sound'MirageRaptorSounds.MirageRaptorIdle'
     StartUpSound=Sound'MirageRaptorSounds.MirageRaptorStart'
     ShutDownSound=Sound'MirageRaptorSounds.MirageRaptorShutDown'
     ...
     Health=350
     Mesh=SkeletalMesh'MirageRaptorOmniAnims.AttackCraft'
     SoundVolume=160
     ...
     End Object
     KParams=KarmaParamsRBFull'MirageRaptorOmni.MirageRaptorOmni.KParams0'
