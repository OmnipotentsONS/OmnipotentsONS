...
//
//-----------------------------------------------------------
class MinotaurClassicCannon extends ONSWeapon;
...
defaultproperties
{
     ...
     EffectEmitterClass=Class'MinotaurClassic.MinotaurClassicFireEffect'
     ...
     ProjectileClass=Class'MinotaurClassic.MinotaurClassicRocketProjectile'
