class MinoClassicTurretBeamEffect extends Emitter;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter0
         ...
         ColorScale(0)=(Color=(B=32,G=89,R=192))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=28,G=105,R=205))
     ...
     End Object
     Emitters(0)=BeamEmitter'MinotaurClassic.MinoClassicTurretBeamEffect.BeamEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=10,G=70,R=235))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.800000
         MaxParticles=1
         UseRotationFrom=PTRS_Actor
         ...
         StartVelocityRange=(X=(Min=500.000000,Max=500.000000))
     End Object
     Emitters(1)=BeamEmitter'MinotaurClassic.MinoClassicTurretBeamEffect.BeamEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter17
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=128,G=180,R=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=2,G=56,R=175))
         MaxParticles=2
         UseRotationFrom=PTRS_Actor
     ...
     End Object
     Emitters(2)=SpriteEmitter'MinotaurClassic.MinoClassicTurretBeamEffect.SpriteEmitter17'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter19
         ...
         ColorScale(0)=(Color=(B=128,G=200,R=255))
         ColorScale(1)=(RelativeTime=0.650000,Color=(G=30,R=182))
         ColorScale(2)=(RelativeTime=1.000000)
         MaxParticles=8
     ...
     End Object
     Emitters(3)=SpriteEmitter'MinotaurClassic.MinoClassicTurretBeamEffect.SpriteEmitter19'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter20
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=32,G=90,R=255))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=24,G=78,R=235))
         ...
         LifetimeRange=(Min=0.200000,Max=0.200000)
     End Object
     Emitters(4)=SpriteEmitter'MinotaurClassic.MinoClassicTurretBeamEffect.SpriteEmitter20'
