class MinoClassicTurretBeamEffectBlue extends MinoClassicTurretBeamEffect;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter4
         ...
         ColorScale(0)=(Color=(B=176,G=50,R=100))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=255,G=100,R=60,A=128))
     ...
     End Object
     Emitters(0)=BeamEmitter'MinotaurClassic.MinoClassicTurretBeamEffectBlue.BeamEmitter4'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter5
         ...
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=235,R=108))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.800000
         MaxParticles=1
         UseRotationFrom=PTRS_Actor
         ...
         StartVelocityRange=(X=(Min=500.000000,Max=500.000000))
     End Object
     Emitters(1)=BeamEmitter'MinotaurClassic.MinoClassicTurretBeamEffectBlue.BeamEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=128,G=4,R=56))
         MaxParticles=2
         UseRotationFrom=PTRS_Actor
     ...
     End Object
     Emitters(2)=SpriteEmitter'MinotaurClassic.MinoClassicTurretBeamEffectBlue.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         ColorScale(1)=(RelativeTime=0.200000,Color=(B=140,G=55,R=10))
         ColorScale(2)=(RelativeTime=0.650000,Color=(B=132,R=23))
     ...
     End Object
     Emitters(3)=SpriteEmitter'MinotaurClassic.MinoClassicTurretBeamEffectBlue.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=235,R=108))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=255,R=98))
         ColorScale(3)=(RelativeTime=1.000000)
         MaxParticles=4
         ...
         LifetimeRange=(Min=0.200000,Max=0.200000)
     End Object
     Emitters(4)=SpriteEmitter'MinotaurClassic.MinoClassicTurretBeamEffectBlue.SpriteEmitter2'
