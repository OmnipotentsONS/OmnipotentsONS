Class CSMarvinProjEmitterRed extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=pgSpriteEmitter
         ...
         ColorScale(0)=(Color=(B=147,G=255,R=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=147,G=198,R=255))
     ...
     End Object
     Emitters(0)=SpriteEmitter'CSMarvin.CSMarvinProjEmitterRed.pgSpriteEmitter'
     ...
     Begin Object Class=SpriteEmitter Name=pgSpriteEmitter2
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=0,G=43,R=213))
         CoordinateSystem=PTCS_Relative
         MaxParticles=30
     ...
     End Object
     Emitters(1)=SpriteEmitter'CSMarvin.CSMarvinProjEmitterRed.pgSpriteEmitter2'
