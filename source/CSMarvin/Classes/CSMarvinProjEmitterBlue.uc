...
Class CSMarvinProjEmitterBlue extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=pgSpriteEmitter
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=147))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=198,R=147))
     ...
     End Object
     Emitters(0)=SpriteEmitter'CSMarvin.CSMarvinProjEmitterBlue.pgSpriteEmitter'
     ...
     Begin Object Class=SpriteEmitter Name=pgSpriteEmitter2
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=83))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=213,G=43,R=0))
         CoordinateSystem=PTCS_Relative
         MaxParticles=30
     ...
     End Object
     Emitters(1)=SpriteEmitter'CSMarvin.CSMarvinProjEmitterBlue.pgSpriteEmitter2'
