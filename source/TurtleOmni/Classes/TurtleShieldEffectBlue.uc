class TurtleShieldEffectBlue extends Emitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter18
         ...
         ColorScale(0)=(Color=(B=164,G=255,R=64))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=214,G=255,R=64))
     ...
     End Object
     Emitters(0)=MeshEmitter'TurtleOmni.TurtleShieldEffectBlue.MeshEmitter18'
