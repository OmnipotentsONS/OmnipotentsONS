class EXBotTransformRifle extends Weapon
    config(user);
...
defaultproperties
{
     FireModeClass(0)=Class'CSAPVerIV.WF_EXBotTransformFire'
     FireModeClass(1)=Class'CSAPVerIV.WF_EXBotTransformFire'
     AIRating=0.680000
     ...
     DrawScale=0.010000
     DrawScale3D=(X=0.010000,Y=0.010000,Z=0.100000)
     AmbientGlow=0
     bOwnerNoSee=True
}
