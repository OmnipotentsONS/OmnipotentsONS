class FX_VehDeathExcalibur extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'CSAPVerIV.FX_VehDeathExcalibur.SpriteEmitter17'

     Begin Object Class=MeshEmitter Name=MeshEmitter26
         StaticMesh=StaticMesh'APVerIV_ST.Excalibur_ST.NoseDestroy'
     ...
     End Object
     Emitters(1)=MeshEmitter'CSAPVerIV.FX_VehDeathExcalibur.MeshEmitter26'

     Begin Object Class=MeshEmitter Name=MeshEmitter27
         StaticMesh=StaticMesh'APVerIV_ST.Excalibur_ST.LWingDestroy'
         UseMeshBlendMode=False
         UseParticleColor=True
         UseCollision=True
         UseColorScale=True
     ...
     End Object
     Emitters(2)=MeshEmitter'CSAPVerIV.FX_VehDeathExcalibur.MeshEmitter27'

     Begin Object Class=MeshEmitter Name=MeshEmitter28
         StaticMesh=StaticMesh'APVerIV_ST.Excalibur_ST.RWingDestroy'
         UseMeshBlendMode=False
         UseParticleColor=True
         UseCollision=True
         UseColorScale=True
         ...
         StartVelocityRange=(Y=(Min=-600.000000,Max=-800.000000),Z=(Min=300.000000,Max=500.000000))
     End Object
     Emitters(3)=MeshEmitter'CSAPVerIV.FX_VehDeathExcalibur.MeshEmitter28'

     Begin Object Class=MeshEmitter Name=MeshEmitter29
         StaticMesh=StaticMesh'APVerIV_ST.Excalibur_ST.ExFusalge'
         UseMeshBlendMode=False
         UseParticleColor=True
         UseCollision=True
         UseColorScale=True
     ...
     End Object
     Emitters(4)=MeshEmitter'CSAPVerIV.FX_VehDeathExcalibur.MeshEmitter29'
