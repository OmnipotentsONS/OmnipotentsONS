class FX_IONTurret_LaserCannon_FireEffectRed extends Actor;

#exec OBJ LOAD FILE=XEffectMat.utx

var Vector			HitLocation, HitNormal;
var FX_IONLaserIonCoreRed		IonCore;
var FX_IONLaserPlasmaBeamRed	BeamEffect;
...
simulated function SpawnEffects()
{
	...
	SetRotation( R );
	BeamEffect = Spawn(class'FX_IONLaserPlasmaBeamRed',,, Location, Rotation);
	IonCore = Spawn(class'FX_IONLaserIonCoreRed',,, Location, Rotation);
...
state Drop
{
    ...
    simulated function Timer()
    {
		...
		A = Spawn(class'FX_IONTurret_LaserCannon_BeamExplosionRed',,, HitLocation+HitNormal*32, Rotator(HitNormal) );
