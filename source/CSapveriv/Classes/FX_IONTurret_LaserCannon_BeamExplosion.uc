...
class FX_IONTurret_LaserCannon_BeamExplosion extends Emitter
	placeable;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter7
         ...
         ColorScale(1)=(RelativeTime=0.200000,Color=(B=250,G=128))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=250,G=128))
     ...
     End Object
     Emitters(0)=SpriteEmitter'CSAPVerIV.FX_IONTurret_LaserCannon_BeamExplosion.SpriteEmitter7'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(1)=(RelativeTime=0.700000,Color=(B=255,G=255))
     ...
     End Object
     Emitters(1)=SpriteEmitter'CSAPVerIV.FX_IONTurret_LaserCannon_BeamExplosion.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(0)=(RelativeTime=1.000000,Color=(B=255,G=168))
         MaxParticles=1
     ...
     End Object
     Emitters(2)=SpriteEmitter'CSAPVerIV.FX_IONTurret_LaserCannon_BeamExplosion.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         ColorScale(0)=(RelativeTime=1.000000,Color=(B=255,G=255))
         MaxParticles=40
         StartLocationShape=PTLS_Sphere
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(3)=SpriteEmitter'CSAPVerIV.FX_IONTurret_LaserCannon_BeamExplosion.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         AutomaticInitialSpawning=False
         BlendBetweenSubdivisions=True
         ColorScale(0)=(RelativeTime=1.000000,Color=(B=204,G=102))
         MaxParticles=50
         StartLocationShape=PTLS_Sphere
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(4)=SpriteEmitter'CSAPVerIV.FX_IONTurret_LaserCannon_BeamExplosion.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter13
         ...
         AutomaticInitialSpawning=False
         BlendBetweenSubdivisions=True
         ColorScale(0)=(RelativeTime=1.000000,Color=(B=204,G=153))
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(5)=SpriteEmitter'CSAPVerIV.FX_IONTurret_LaserCannon_BeamExplosion.SpriteEmitter13'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter0
         ...
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=255,G=255,R=255))
         ColorScale(1)=(RelativeTime=0.800000,Color=(B=255,G=153,R=51))
         ColorScale(2)=(RelativeTime=1.000000)
         Opacity=0.500000
         MaxParticles=1
         ...
         InitialDelayRange=(Min=1.700000,Max=1.700000)
     End Object
     Emitters(6)=MeshEmitter'CSAPVerIV.FX_IONTurret_LaserCannon_BeamExplosion.MeshEmitter0'
