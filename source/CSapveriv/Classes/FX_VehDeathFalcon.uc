class FX_VehDeathFalcon extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'CSAPVerIV.FX_VehDeathFalcon.SpriteEmitter17'

     Begin Object Class=MeshEmitter Name=MeshEmitter26
         StaticMesh=StaticMesh'APVerIV_ST.FalconST.FrontA'
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         Acceleration=(X=100.000000,Y=32.000000)
     ...
     End Object
     Emitters(1)=MeshEmitter'CSAPVerIV.FX_VehDeathFalcon.MeshEmitter26'

     Begin Object Class=MeshEmitter Name=MeshEmitter27
         StaticMesh=StaticMesh'APVerIV_ST.FalconST.LowerWingDes'
         UseMeshBlendMode=False
         UseParticleColor=True
         UseCollision=True
         UseColorScale=True
         ...
         MaxParticles=1
         StartLocationOffset=(Y=100.000000,Z=-86.000000)
     ...
     End Object
     Emitters(2)=MeshEmitter'CSAPVerIV.FX_VehDeathFalcon.MeshEmitter27'

     Begin Object Class=MeshEmitter Name=MeshEmitter29
         StaticMesh=StaticMesh'APVerIV_ST.FalconST.FalconFusalge'
         UseMeshBlendMode=False
         UseParticleColor=True
         UseCollision=True
         UseColorScale=True
     ...
     End Object
     Emitters(3)=MeshEmitter'CSAPVerIV.FX_VehDeathFalcon.MeshEmitter29'
