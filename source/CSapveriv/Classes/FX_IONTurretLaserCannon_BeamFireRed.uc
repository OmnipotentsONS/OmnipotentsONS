//=============================================================================
// FX_TurretLaserCannon_BeamFire
//=============================================================================

class FX_IONTurretLaserCannon_BeamFireRed extends Actor;
...
var()	class<FX_IONTurret_LaserCannon_FireEffectRed> IonEffectClass;
...
state FireSequence
{
    ...
    {
        local FX_IONTurret_LaserCannon_FireEffectRed IonBeamEffect;
...
defaultproperties
{
     ...
     DamageRadius=5512.000000
     DamageType=Class'UT2k4AssaultFull.DamTypeIonCannonBlast'
     IonEffectClass=Class'CSAPVerIV.FX_IONTurret_LaserCannon_FireEffectRed'
