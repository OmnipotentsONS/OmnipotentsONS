...
class FX_IONLaserIonCore extends Emitter
	placeable;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter82
         ...
         ColorScale(2)=(RelativeTime=0.500000,Color=(B=192,G=128))
     ...
     End Object
     Emitters(0)=SpriteEmitter'CSAPVerIV.FX_IONLaserIonCore.SpriteEmitter82'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter83
         ...
         LifetimeRange=(Min=1.500000,Max=1.500000)
     End Object
     Emitters(1)=SpriteEmitter'CSAPVerIV.FX_IONLaserIonCore.SpriteEmitter83'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter84
         ...
         ColorScale(1)=(RelativeTime=0.150000,Color=(B=255,G=255))
         ColorScale(2)=(RelativeTime=0.670000,Color=(B=192,G=128))
         ColorScale(3)=(RelativeTime=1.000000)
         ColorMultiplierRange=(Y=(Max=2.000000))
         CoordinateSystem=PTCS_Relative
         MaxParticles=30
     ...
     End Object
     Emitters(2)=SpriteEmitter'CSAPVerIV.FX_IONLaserIonCore.SpriteEmitter84'
