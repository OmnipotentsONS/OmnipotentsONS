class FX_VehDeathUTSpaceFighterSkarj extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'CSAPVerIV.FX_VehDeathUTSpaceFighterSkarj.SpriteEmitter17'

     Begin Object Class=MeshEmitter Name=MeshEmitter26
         StaticMesh=StaticMesh'APVerIV_ST.SFighterDestroyed.SFighterNose'
     ...
     End Object
     Emitters(1)=MeshEmitter'CSAPVerIV.FX_VehDeathUTSpaceFighterSkarj.MeshEmitter26'

     Begin Object Class=MeshEmitter Name=MeshEmitter27
         StaticMesh=StaticMesh'APVerIV_ST.SFighterDestroyed.SFighterWing'
         UseMeshBlendMode=False
         UseParticleColor=True
         UseCollision=True
         UseColorScale=True
     ...
     End Object
     Emitters(2)=MeshEmitter'CSAPVerIV.FX_VehDeathUTSpaceFighterSkarj.MeshEmitter27'

     Begin Object Class=MeshEmitter Name=MeshEmitter28
         StaticMesh=StaticMesh'APVerIV_ST.SFighterDestroyed.SFighterWingR'
         UseMeshBlendMode=False
         UseParticleColor=True
         UseCollision=True
         UseColorScale=True
         ...
         StartVelocityRange=(Y=(Min=-600.000000,Max=-800.000000),Z=(Min=300.000000,Max=500.000000))
     End Object
     Emitters(3)=MeshEmitter'CSAPVerIV.FX_VehDeathUTSpaceFighterSkarj.MeshEmitter28'

     Begin Object Class=MeshEmitter Name=MeshEmitter29
         StaticMesh=StaticMesh'APVerIV_ST.SFighterDestroyed.SFighterRear'
         UseMeshBlendMode=False
         UseParticleColor=True
         UseCollision=True
         UseColorScale=True
     ...
     End Object
     Emitters(4)=MeshEmitter'CSAPVerIV.FX_VehDeathUTSpaceFighterSkarj.MeshEmitter29'
