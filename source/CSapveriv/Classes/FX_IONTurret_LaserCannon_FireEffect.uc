class FX_IONTurret_LaserCannon_FireEffect extends Actor;

#exec OBJ LOAD FILE=XEffectMat.utx

var Vector			HitLocation, HitNormal;
var FX_IONLaserIonCore		IonCore;
var FX_IONLaserPlasmaBeam	BeamEffect;
...
simulated function SpawnEffects()
{
	...
	SetRotation( R );
	BeamEffect = Spawn(class'FX_IONLaserPlasmaBeam',,, Location, Rotation);
	IonCore = Spawn(class'FX_IONLaserIonCore',,, Location, Rotation);
...
state Drop
{
    ...
    simulated function Timer()
    {
		...
		A = Spawn(class'FX_IONTurret_LaserCannon_BeamExplosion',,, HitLocation+HitNormal*32, Rotator(HitNormal) );
