...
class UTSpaceFighter extends AirPower_Fighter config(CSAPVerIV);
 ...
 if (LeftWingLight==none && Health>0 && Team != 255 )
          {
           ...
           AttachToBone(LeftWingLight, 'WingLeft');

		   RightWingLight=spawn(Class'FX_RunningLight',Self,,Location);
           AttachToBone(RightWingLight,'WingRight');

           BottomLight=spawn(Class'FX_RunningLight',Self,,Location);
           AttachToBone(BottomLight,'GearDoorRear');
          }
...
defaultproperties
{
     RedSkinB=Combiner'AS_Vehicles_TX.SpaceFighter.SpaceFighter_Human2_C'
     BlueSkinB=Combiner'APVerIV_Tex.ExcaliburSkins.ExcaliCombB'
     SpecialSkinA=Texture'APVerIV_Tex.ExcaliburSkins.EvilMonarchSkinA'
     SpecialSkinB=Texture'APVerIV_Tex.ExcaliburSkins.EvilMonarchSkinB'
     ...
     RedSkin=Combiner'AS_Vehicles_TX.SpaceFighter.SpaceFighter_Human1_C'
     BlueSkin=Combiner'APVerIV_Tex.ExcaliburSkins.ExcaliCombA'
     ...
     FlybySound=Sound'APVerIV_Snd.SpaceFighterFlyby'
     FlybyInterval=6.500000
     RequiredFighterEquipment(0)="CSAPVerIV.Weapon_UTSpaceFighter"
     VehicleProjSpawnOffset=(X=110.000000,Y=22.000000,Z=-64.000000)
     VehicleProjSpawnOffsetLeft=(Y=-36.000000,Z=-14.000000)
     VehicleProjSpawnOffsetRight=(Y=36.000000,Z=-14.000000)
     ExplosionEffectClass=Class'CSAPVerIV.FX_VehDeathUTSpaceFighter'
     IdleSound=Sound'AssaultSounds.HumanShip.HnSpaceShipEng01'
     StartUpSound=Sound'AssaultSounds.HumanShip.HnShipAccel01'
     ShutDownSound=Sound'AssaultSounds.HumanShip.HnShipDecel01'
