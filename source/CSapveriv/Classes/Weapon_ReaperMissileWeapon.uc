class Weapon_ReaperMissileWeapon extends ONSWeapon;
...
state ProjectileFireMode
{
	...
	{
		local PROJ_ReaperMissle M;
		local float BestAim, BestDist;
        M = PROJ_ReaperMissle(SpawnProjectile(ProjectileClass, True));
		if (M != None)
		{
...
defaultproperties
{
     ...
     FireForce="Laser01"
     ProjectileClass=Class'CSAPVerIV.PROJ_ReaperMissle'
