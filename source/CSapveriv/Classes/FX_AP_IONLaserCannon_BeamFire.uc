...
class FX_AP_IONLaserCannon_BeamFire extends Actor;
...
var()	class<FX_IONTurret_LaserCannon_FireEffect> IonEffectClass;
...
state FireSequence
{
    ...
    {
        local FX_IONTurret_LaserCannon_FireEffect IonBeamEffect;
...
defaultproperties
{
     ...
     IonEffectClass=Class'CSAPVerIV.FX_IONTurret_LaserCannon_FireEffect'
