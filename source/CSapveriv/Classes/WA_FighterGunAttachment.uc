//=============================================================================
// WA_FighterGunAttachment
//=============================================================================
// Created by Laurent Delayen
// � 2003, Epic Games, Inc.  All Rights Reserved
//=============================================================================

class WA_FighterGunAttachment extends xWeaponAttachment;
...
simulated function PlayFireFX( float fSide )
{
	...
	if ( OldSpawnHitCount != SpawnHitCount )
	{
		...
		{
			FX_Impact = Spawn(class'FX_PlasmaImpact',,,HL + HN * 1, rotator(HN));
	...
	if ( Instigator != None && AirPower_Fighter(Instigator) != None )
	   {
        if (bLeft)
		  {
		   MuzzleSpawnOffset = AirPower_Fighter(Instigator).VehicleProjSpawnOffset;
           bleft=false;
          }
        else
          {
           MuzzleSpawnOffset = AirPower_Fighter(Instigator).VehicleProjSpawnOffset;
           MuzzleSpawnOffset= MuzzleSpawnOffset * -1;
           bleft=true;
          }
        }
