...
class Factory_TurretFactory extends SVehicleFactory
	placeable;
...
var		Factory_TurretFactory	NextFactory;
...
simulated function PostBeginPlay()
{
	...
	{
		if ( NextFactoryTag != '' )
			foreach AllActors(class'Factory_TurretFactory', NextFactory, NextFactoryTag)
				break;
