//=============================================================================
// FX_Fighter_Explosion
//=============================================================================

class FX_Fighter_Explosion extends Emitter
	placeable;
...
defaultproperties
{
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         StartSizeRange=(X=(Min=350.000000,Max=600.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'CSAPVerIV.FX_Fighter_Explosion.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         StartSizeRange=(X=(Min=850.000000,Max=850.000000))
         InitialParticlesPerSecond=2000.000000
         Texture=Texture'EpicParticles.Flares.SoftFlare'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=1.670000,Max=1.670000)
     End Object
     Emitters(1)=SpriteEmitter'CSAPVerIV.FX_Fighter_Explosion.SpriteEmitter1'
     ...
     End Object
     Emitters(2)=SpriteEmitter'CSAPVerIV.FX_Fighter_Explosion.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         StartSizeRange=(X=(Min=10.000000,Max=28.000000))
     ...
     End Object
     Emitters(3)=SpriteEmitter'CSAPVerIV.FX_Fighter_Explosion.SpriteEmitter3'
     ...
     Begin Object Class=TrailEmitter Name=TrailEmitter0
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(4)=TrailEmitter'CSAPVerIV.FX_Fighter_Explosion.TrailEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         StartSpinRange=(X=(Max=1.000000))
         StartSizeRange=(X=(Min=200.000000,Max=650.000000))
         SpawningSound=PTSC_Random
     ...
     End Object
     Emitters(5)=SpriteEmitter'CSAPVerIV.FX_Fighter_Explosion.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         StartSizeRange=(X=(Min=450.000000,Max=750.000000))
         InitialParticlesPerSecond=2000.000000
         Texture=Texture'ExplosionTex.Framed.exp1_frames'
         TextureUSubdivisions=2
         TextureVSubdivisions=4
     ...
     End Object
     Emitters(6)=SpriteEmitter'CSAPVerIV.FX_Fighter_Explosion.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         StartSizeRange=(X=(Min=9.000000,Max=36.000000))
         InitialParticlesPerSecond=300.000000
         DrawStyle=PTDS_AlphaBlend
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(7)=SpriteEmitter'CSAPVerIV.FX_Fighter_Explosion.SpriteEmitter6'
