...
class FX_IONLaserPlasmaBeam extends Emitter
	placeable;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         ColorScale(1)=(RelativeTime=0.500000,Color=(B=255,G=26))
     ...
     End Object
     Emitters(0)=BeamEmitter'CSAPVerIV.FX_IONLaserPlasmaBeam.BeamEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter79
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=255,G=204))
     ...
     End Object
     Emitters(1)=SpriteEmitter'CSAPVerIV.FX_IONLaserPlasmaBeam.SpriteEmitter79'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter80
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=255))
         ColorScale(1)=(RelativeTime=0.500000,Color=(B=255,G=51))
         ColorScale(2)=(RelativeTime=1.000000)
     ...
     End Object
     Emitters(2)=SpriteEmitter'CSAPVerIV.FX_IONLaserPlasmaBeam.SpriteEmitter80'
