//=============================================================================
// WA_RoboRocketAttachment
//=============================================================================
// Created by Laurent Delayen
// © 2003, Epic Games, Inc.  All Rights Reserved
//=============================================================================

class WA_RoboRocketAttachment extends xWeaponAttachment;
	...
	if ( Instigator != None && Excalibur_Robot(Instigator) != None )
	   {
        if (bLeft)
		  {
		   MuzzleSpawnOffset = Excalibur_Robot(Instigator).RocketOffsetA;
           bleft=false;
          }
        else
          {
           MuzzleSpawnOffset = Excalibur_Robot(Instigator).RocketOffsetB;
           bleft=true;
          }
        }
